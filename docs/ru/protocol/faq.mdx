...
Этот раздел FAQ призван дополнить [серию статей с объяснениями](/ru/protocol/explainer-series) краткими ответами на часто задаваемые нам вопросы.

![Часто задаваемые вопросы Rocket Pool](/images/headers/faq.png)
...
[**Почему мне это нужно?**](#почему-мне-это-нужно)
_Хороший вопрос и, надеюсь, еще лучшие ответы._

[**Как это работает?**](#как-это-работает)
_Смарт-контракты, умные ноды и децентрализованная инфраструктура._

[**Независимый оператор ноды vs Staking as a Service (SaaS) поставщик?**](#независимый-оператор-ноды-vs-staking-as-a-service-saas-поставщик)
_Протоколы могут использоваться всеми, от обычных пользователей до профессиональных поставщиков SaaS._
...
_Это не пришельцы и не рептилоиды. Ну, довольно уверен в этом._

## Стейкинг

[**Какой минимальный депозит?**](#какой-минимальный-депозит)
_Я сэкономлю вам время на прокрутку, это 0,01 ETH._

[**Какой максимальный депозит?**](#какой-максимальный-депозит)
_Сэкономлю вам еще время, лимита нет._

[**Какие периоды стейкинга?**](#какие-периоды-стейкинга)
_Нет ни для стейкеров, ни для операторов ноды. Приходите и уходите как угодно._

[**Сколько стоит стейкинг с Rocket Pool?**](#сколько-стоит-стейкинг-с-rocket-pool)
_Мы не берем комиссию вообще, вместо этого все операторы ноды, которые поддерживают протокол, получают переменные комиссии._

[**Как протокол защищает стоимость rETH?**](#как-протокол-защищает-стоимость-reth)
_Наш главный приоритет! У нас есть много функций для этого._

[**Что именно такое децентрализованный протокол стейкинга?**](#что-именно-такое-децентрализованный-протокол-стейкинга)
_Готовьтесь, что ваш ум будет потрясен._

[**Как я могу получить доступ к своему депозиту и вознаграждениям?**](#как-я-могу-получить-доступ-к-своему-депозиту-и-вознаграждениям)
_Я слышал что-то о том, что выводы недопустимы на некоторое время..._

[**Ваши смарт-контракты отредактированы и имеют открытый исходный код?**](#ваши-смарт-контракты-отредактированы-и-имеют-открытый-исходный-код)
_Конечно! Беты, аудиты, аудиты и еще больше аудитов._

## Операторы ноды

[**Почему я должен запустить умную ноду Rocket Pool вместо того, чтобы делать это в одиночку?**](#почему-я-должен-запустить-умную-ноду-rocket-pool-вместо-того-чтобы-делать-это-в-одиночку)
_Требуется половина ETH, а вы получаете комиссии ETH + дополнительные вознаграждения RPL, вот это да!_

[**Какая минимальная сумма стейкинга для оператора ноды?**](#какая-минимальная-сумма-стейкинга-для-оператора-ноды)
_Это 8 ETH, хотите узнать больше?_

[**Что предполагает запуск ноды Rocket Pool?**](#что-предполагает-запуск-ноды-rocket-pool)
_Некоторое количество ETH, RPL и бесперебойность, бесперебойность, бесперебойность._

[**Как используется токен RPL?**](#как-используется-токен-rpl)
_Выполняйте стейкинг RPL на вашей ноде как обещание страховки протоколу и получайте дополнительные вознаграждения RPL!_

## dApps, SaaS бизнес и многое другое

[**Могу ли я создавать поверх протокола или использовать его в моем SaaS бизнесе?**](#integrated-dapps-saas-business-and-more)
_Подключите свой dApp к децентрализованному стейкингу или запустите ноду в сети и получайте более высокие доходы!_

## Контакты

[**Вебсайт**](https://www.rocketpool.net/)
_Свяжитесь с нами здесь по электронной почте или просто прочитайте о Rocket Pool._

[**Discord**](https://discordapp.com/invite/tCRG54c)
_Зайдите на чат и задайте несколько вопросов, мы дружная группа._

[**Doc Hub**](https://docs.rocketpool.net/)
_Вы читаете это :) Но есть еще несколько статей..._
...
- You get to use our awesome [Smart Node Stack](https://github.com/rocket-pool/smartnode), a super handy setup to make staking very easy. [Get started here with the installer](https://github.com/rocket-pool/smartnode).
...
As a node operator you will need to run a server 24/7 performing proof of stake validator duties. Use our [Smart Node Stack](https://github.com/rocket-pool/smartnode) to manage your node + validators in the protocol, a super handy package to make staking very easy. [Get started here with the installer](https://github.com/rocket-pool/smartnode).

Since the [Saturn 0 upgrade](/en/upgrades/saturn-0/whats-new), the Rocket Pool protocol no longer requires a minimum amount of RPL. Before [Saturn 0 upgrade](/en/upgrades/saturn-0/whats-new), a minimum of 10% of the value in RPL of the ETH provided by the protocol (10% of 24 or 16 ETH respectively, that is, 2.4 or 1.6 ETH) was required.
