...
## Уведомления Smart Node

[Мониторинг вашего стека Smart Node с уведомлениями](./maintenance/alerting.md) проводит вас через использование функциональности уведомлений Smart Node для получения уведомлений о здоровье и важных событиях вашего Rocket Pool Smart Node.
...
Smart Node v1.5.1 включает возможность подписывать сообщения закрытым ключом вашего кошелька узла, используя команду `rocketpool node sign-message`, затем предоставив сообщение, которое вы хотите подписать.
...
Порт для мониторинга зависит от настройки вашего узла; пользователи, использующие типичную установку Smart Node, вероятно, перенаправили порты 30303 и 9001 для клиентов Execution и Consensus соответственно, поэтому это хороший выбор для мониторинга времени работы.
...
::: tip ПРИМЕЧАНИЕ
[Мониторинг вашего стека Smart Node с уведомлениями](./maintenance/alerting.md) проводит вас через использование функциональности уведомлений Smart Node, которая включает уведомление, когда доступны обновления для вашего узла.
:::
