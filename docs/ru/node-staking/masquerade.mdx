...
Начиная с версии Smart Node `v1.15.7`, пользователи могут имитировать поведение произвольного адреса. Во время маскировки под другой адрес ваш node продолжит цикл задач node и watchtower, используя адрес вашего node, и будет выполнять такие обязанности, как аттестация, используя ключи вашего validator. Вы не сможете отправлять транзакции или подписывать сообщения от имени маскируемого адреса. Эта функция особенно полезна для поддержки и отладки.

Если вы хотите взаимодействовать со Smart Node через призму другого адреса node, используйте следующую команду: `rocketpool wallet masquerade`
