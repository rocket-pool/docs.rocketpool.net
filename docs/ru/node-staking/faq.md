...
У вас также будет возможность использовать функцию [Smoothing Pool](./fee-distrib-sp#smoothing-pool) от Rocket Pool.
...
См. [Получение тестового ETH на Hoodi](./testnet/overview#получение-тестовых-eth-на-hoodi).
...
Следуйте [шагам](./install-modes) для установки Smart Node на новую машину.
...
Consensus клиенты могут долго синхронизироваться, если вы не начали процесс синхронизации с использованием [Checkpoint Sync](./config-docker#синхронизация-контрольных-точек-beacon-chain).
