...
Если вы решите включить метрики во время процесса настройки Smart Node, ваш узел добавит следующие процессы:
...
Конфигурация по умолчанию создаст Docker-контейнеры со всеми этими сервисами, которые будут существовать вместе с остальными Docker-контейнерами Smart Node.
...
<div className="p-3">
  <Tabs>
    <Tab label="Docker">
      ...
      Начните с повторного запуска команды настройки Smart Node:
      ...
      Во время этой проверки он также сравнит установленную версию Rocket Pool Smart Node с последним релизом и сообщит вам, если доступна новая версия.
...
Обратитесь к вкладкам ниже для вашего режима установки Smart Node.
...
Когда вам будет предложено ввести ID панели управления в поле **Import via grafana.com**, введите `24900` или используйте полный URL ([https://grafana.com/grafana/dashboards/24900-rocket-pool-dashboard-v1-4-0/](https://grafana.com/grafana/dashboards/24900-rocket-pool-dashboard-v1-4-0/)) и нажмите кнопку **Load**.
...
::: tip ПРИМЕЧАНИЕ
Smart Node v1.23.0 поставляется с **Rocket Pool Dashboard v1.4.2** в составе стека метрик. В этой версии добавлены счётчики валидаторов minipool и megapool по статусам в разрезе ноды и удалены общесетевые панели статуса megapool, которые зависели от убранных метрик supply-collector. Если в вашу Grafana уже импортирована более старая панель, импортируйте её заново (или загрузите JSON, поставляемый со Smart Node), чтобы эти панели соответствовали метрикам, которые экспортирует ваша нода.
:::
...
Они будут снова включены в будущей версии Smart Node, которая сможет правильно отслеживать исторические вознаграждения.
:::
...
Если вы не меняли местоположение Docker по умолчанию на другой диск во время установки Smart Node, то диск, который вы хотите отслеживать, будет тем, на котором установлена ваша операционная система.
