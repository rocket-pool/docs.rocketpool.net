...
Эта команда позволит вам внести ETH и создать новый minipool (новый валидатор Ethereum).

Вам будет показана ожидаемая стоимость газа для транзакции и одно последнее диалоговое окно подтверждения.
Если вы примете, ваш депозит ETH будет обработан, и вы создадите новый minipool (и соответствующий валидатор Ethereum).

(Для получения дополнительной информации см. следующий раздел о [Создании Minipool](./create-validator.mdx)).
