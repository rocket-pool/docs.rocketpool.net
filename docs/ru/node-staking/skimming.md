# Распределение снятых вознаграждений minipool
...
По умолчанию Smart Node настроен на автоматическое распределение любого из ваших minipools, когда их индивидуальные балансы достигают **1 ETH**. Этот
...
Изменение этой настройки изменит порог, при котором Smart Node будет автоматически распределять ваши minipools.
...
основе. Прочитайте [раздел о ручном распределении](#ручное-распределение), следующий за этим, о том, как это сделать.
...
его баланс превышает 8 ETH. Чтобы защитить ваш капитал, Smart Node отслеживает эту ситуацию и автоматически выведет
