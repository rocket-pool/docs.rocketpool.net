...
If you're here, then you've successfully started the Smart Node services, created a wallet, and finished syncing both the Execution and Consensus chains on your respective clients.
...
3. After the previous transaction is confirmed, you can use the Smart Node CLI to setup the **reverse resolution**. This will allow applications to map back from your node wallet address to your `.eth` name.
