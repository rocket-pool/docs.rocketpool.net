...
You will have peace of mind with a larger drive. The size of this database can be reduced if you [decide to not to store history before the merge](/node-staking/maintenance/history-expiry).
