...
::: warning NOTE
bloXroute **Max Profit** is no longer a selectable relay. After you next save MEV-Boost / Commit-Boost settings, look at the relay list. If Max Profit was the **only** relay you had enabled on Mainnet, the Smartnode moves you to **bloXroute Regulated**. Add any other relays you want before you restart.
:::
