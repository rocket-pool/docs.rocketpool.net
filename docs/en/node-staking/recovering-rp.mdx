...
If you do not specify this flag, the Smartnode will attempt to recover the validator keys for your minipools or megapool validators. That step needs synced Execution and Beacon clients.
