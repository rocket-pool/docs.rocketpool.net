...
<div className="p-3">
  <Tabs>
    <Tab label="Locally Managed">
      ...
      If you choose **Erigon**, also forward its **Torrent Port** (default **42069**, TCP and UDP) as well as Execution P2P **30303**, so snapshot sync and peering work. The Wizard still uses sensible defaults for everything else.
