...
At this point, you can access it using the Smart Node CLI to do a distribution.
...
Because of these deficiencies, the Smart Node CLI **no longer supports** withdrawals or fund distribution on the original minipool delegate.
