...
Starting with Smart Node version `v1.15.7`, users will be able to mock the behaviour of an arbitrary address. While masquerading as another address,
...
If you wish to interact with the Smart Node through the lens of another node address, please use the following command: `rocketpool wallet masquerade`
