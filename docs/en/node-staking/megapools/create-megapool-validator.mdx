...
The node operator is [credited](/node-staking/megapools/credit) the remaining 3 ETH from their bond with a dissolve penalty of 0.05 ETH applied as debt. The net credit for a dissolved validator is 2.95 ETH. 
