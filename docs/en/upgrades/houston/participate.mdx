...
Learn more about how this all works via: /en/legacy/houston/participate#participating-in-on-chain-pdao-proposals
...
<div className="p-3">
  <Tabs>
    <Tab label="Viewing a List of Proposals">
      ...
      [challengers](/en/legacy/houston/pdao#challenge-process) can dispute the validity of the
