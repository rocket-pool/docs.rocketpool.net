...
Smart Node sürüm `v1.15.7`'den başlayarak, kullanıcılar rastgele bir adresin davranışını taklit edebilecektir. Başka bir adres olarak maskelenirken,
...
Smart Node ile başka bir node adresi üzerinden etkileşimde bulunmak istiyorsanız, lütfen şu komutu kullanın: `rocketpool wallet masquerade`
