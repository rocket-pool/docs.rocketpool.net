...
Execution istemcileri, zincir verilerinin yönetilebilir bir boyutta kalması için eski blok gövdelerini ve makbuzlarını atabilir. Bunu Smart Node'un **Pruning Mode** ayarı (Execution Client → Pruning Mode) denetler.
