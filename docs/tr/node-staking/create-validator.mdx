...
Düğümünüz adına stake etmek için bir adresin beyaz listeye alınması gerekir. Çekim adresiniz her zaman beyaz listede olup, RPL'niz çekim adresiniz tarafından tutuluyorsa bu adımı atlayabilirsiniz. Bir adresten stake etmek için yalnızca bir kez beyaz listeye almanız gerekir. Bunu aşağıdaki Smart Node komutuyla yapabilirsiniz:
...
Bir adresi stake-on-behalf beyaz listenizden çıkarmak isterseniz, bunu aşağıdaki Smart Node komutuyla yapabilirsiniz:
...
Ancak, Smart Node minipool için özel bir **vanity adresi** arama yeteneği sağlar.
...
[Başarılı bir stake'in nasıl onaylanacağı hakkında daha fazla bilgi edinin](./create-validator#başarılı-bir-stakei-onaylama)
...
İlk olarak, yeni bir minipool yatırmanın düğümünüzün [fee distributor](./fee-distrib-sp) sözleşmesindeki (MEV ödüllerini yakalamak için kullanılır, [Smoothing Pool](./fee-distrib-sp#smoothing-pool)'a katılmadıysanız) herhangi bir bakiyeyi **otomatik olarak dağıtacağına** dair bir not göreceksiniz:
