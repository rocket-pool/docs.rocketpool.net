...
Düğümünüzü tamamen kilitlemek için [güvenlik duvarını etkinleştirme](/tr/node-staking/securing-your-node#temel-güvenlik-duvarı-etkinleştirme) adımlarından SSH portuna eklenen erişimi de kaldırabilirsiniz.
