...
Smart Node şu anda bir GUI'ye (Grafiksel Kullanıcı Arayüzü) sahip değil, yalnızca bir CLI'ye (Komut Satırı Arayüzü) sahiptir, bu da onunla etkileşim kurmanın tamamen komut satırı terminaline komutlar yazarak yapıldığı anlamına gelir.
