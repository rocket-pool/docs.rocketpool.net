...
Merkle Ağacı bir JSON dosyasına yerleştirilir ve [bakımını yaptığımız bir GitHub deposunda](https://github.com/rocket-pool/rewards-trees/) barındırılır. Smartnode ayrıca ödül aralığı **olaylarını** bu GitHub deposundan yükleyebilir, böylece agresif geçmiş sona erdirme eski Execution katmanı günlüklerini sildikten sonra bile talep edebilirsiniz.
