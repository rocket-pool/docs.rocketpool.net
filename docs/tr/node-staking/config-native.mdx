...
- [Ayarlar Yöneticisi UI](#ayarlar-yöneticisi-ile-yapılandırma) ile - bu size Smartnode'un tüm ayarlarına erişim sağlar, böylece istediğiniz kadar her şeyi özelleştirebilirsiniz.
- [Komut Satırı](#komut-satırı-ile-yapılandırma) ile başsız olarak - bu, Smartnode'u başsız (etkileşimsiz) bir ortamda çalıştıran ve otomatik olarak yapılandırması gereken kişiler için bir seçenektir.
...
::: tip NOT
Smartnode'u zaten yapılandırdıysanız, bunun yerine [Ayarlar Yöneticisi](#ayarlar-yöneticisi-ile-yapılandırma) ile karşılaşacaksınız.
