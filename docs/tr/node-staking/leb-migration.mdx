...
[Örnek matematik](./create-validator.mdx) bölümünde gösterildiği gibi, %14'lük bir 8-ETH minipool'un %20'lik bir 16-ETH minipool'dan _hala daha karlı olduğunu_ unutmayın, bu nedenle yüksek bir komisyon oranını tutmak 16 ETH bond'u korumak için ikna edici bir neden değildir.
:::
...
Azaltmak için bir veya daha fazla minipool seçtiğinizde, Smart Node bu minipool'ların bond azaltma için uygun olup olmadığını kontrol edecektir.
...
Bu kredi, ücretsiz olarak [başka bir 8-ETH minipool yapmak](./create-validator.mdx#eth-yatırma-ve-minipool-oluşturma) için kullanılabilir (node cüzdanından ETH gerekmez, sadece gas için)!
