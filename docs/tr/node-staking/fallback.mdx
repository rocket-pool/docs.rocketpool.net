...
Bu durumda, birincil node makineniz hala minipool'larınızın validator anahtarlarıyla onaylama ve blok önerme işlemlerinden sorumlu olacaktır, ancak Execution katmanı ve Beacon zinciriyle etkileşim kurmak için harici bir makineye bağlanacaktır.
