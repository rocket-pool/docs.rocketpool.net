...
- Smoothing Pool'a **katıldıysanız**, bu **Smoothing Pool sözleşmesinin** adresi olmalıdır. Adresi [resmi sözleşmeler sayfasından](/tr/overview/contracts-integrations) alabilirsiniz.
...
**Redstone dağıtılmadan önce**, üzerinde bulunduğunuz ağ için rETH adresini kullanabilirsiniz ([resmi sözleşmeler sayfasında](/tr/overview/contracts-integrations) bulunabilir).
...
<div className="p-3">
  <Tabs>
    <Tab label="Lighthouse">
      ...
      - Redstone güncellemesi dağıtılmadan **önce** [rETH adresi](/tr/overview/contracts-integrations/#token-contracts) (örneğin, Mainnet'te `0xae78736Cd615f374D3085123A210448E74Fc6393`)
      ...
      - Smoothing Pool'a katılırsanız [Smoothing Pool adresi](/tr/overview/contracts-integrations/#protocol-contracts)
