...
Una propuesta debe ser prevista por el [proceso de gobernanza](../houston/participate#proceso-de-gobernanza) antes de terminar on-chain. Consiste en 4 Períodos, todos los cuales son [parámetros controlables](https://rpips.rocketpool.net/RPIPs/RPIP-33#parameter-table) del pDAO:
...
Cuando esta configuración está habilitada, el nodo verificará nuevas propuestas, verificará su corrección y enviará desafíos a propuestas inválidas. El único requisito previo es que el [Bloqueo de RPL](../houston/participate#permitir-el-bloqueo-de-rpl) esté habilitado.
...
Ahora que la propuesta es derrotada, nuestro nodo (el desafiador) puede [reclamar](../houston/participate#reclamar-bonos-y-recompensas) su bono de RPL original así como el bono de RPL del proponente como recompensa por derrotar una propuesta fraudulenta.
