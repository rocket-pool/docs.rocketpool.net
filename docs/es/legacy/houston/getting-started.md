...
[Configurando tu Dirección de Señalización de Snapshot](../houston/participate#establecer-tu-dirección-de-señalización-de-snapshot).

### Delegando el Poder de Voto On-Chain

Si deseas delegar el poder de voto on-chain a un miembro de la comunidad de tu elección, haz clic [aquí](../houston/participate#delegar-poder-de-voto) para aprender cómo.
