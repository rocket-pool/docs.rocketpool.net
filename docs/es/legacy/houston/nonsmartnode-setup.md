...
Algunos usuarios (por ejemplo, usuarios de Allnodes) no usan el smartnode y pueden necesitar configurar la votación mediante interacción directa con los contratos.
Esta guía contiene tanto una guía de configuración mínima como una completa para dichos usuarios.

::: tip
Tu dirección de nodo debe estar cargada en una wallet de hardware para esto.
:::

## Guía de configuración mínima

Esto permite que tu delegado vote por ti on-chain y offchain. Podrás anular a tu delegado on-chain, pero no off-chain.
...
- Inicializa la votación con tu propio nodo como delegado https://etherscan.io/address/0xA9d27E1952f742d659143a544d3e535fFf3Eebe1#writeContract#F1
  ...
  - Sugeriría principalmente esta opción para personas que desean ser delegados, ya que _necesitan_ votar cada vez.
...
- Ve a https://node.rocketpool.net/signalling-address y conecta tu dirección de nodo
  ...
  - Nota: tu dirección de señalización de snapshot NO DEBE ser tu dirección de nodo
- En una nueva pestaña, ve a https://etherscan.io/address/0xc1062617d10Ae99E09D941b60746182A87eAB38F#writeContract#F2
  ...
  - Completa los argumentos con tu dirección de señalización y los parámetros r, s, v dados en el paso anterior
