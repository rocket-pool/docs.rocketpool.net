...
El Smart Node actualmente no tiene una GUI (Interfaz Gráfica de Usuario), solo una CLI (Interfaz de Línea de Comandos), lo que significa que interactuar con él se hace completamente escribiendo comandos en un terminal de línea de comandos.
