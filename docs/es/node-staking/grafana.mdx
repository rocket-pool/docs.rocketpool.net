...
Cuando se te solicite el ID del panel en el cuadro **Import via grafana.com**, ingresa `21863` o usa la URL completa ([(https://grafana.com/grafana/dashboards/21863](https://grafana.com/grafana/dashboards/21863)) y presiona el botón **Load**.
