...
En este punto, puedes acceder a él usando la CLI de Smart Node para hacer una distribución.
...
A diferencia de la [distribución manual](./skimming#distribución-manual), este proceso **finalizará** realmente tu minipool, lo que lo cierra y lo deja inactivo.
...
Debido a estas deficiencias, la CLI de Smart Node **ya no soporta** retiros o distribución de fondos en el delegado de minipool original.
