...
::: tip NOTA
Si ya has configurado Smartnode, en su lugar serás recibido con el [Administrador de Configuración](#configuración-a-través-del-administrador-de-configuración).
