...
Si no especificas este indicador, el Smartnode intentará recuperar las claves de validador para tus minipools o validadores de megapool. Ese paso requiere clientes de Ejecución y Beacon sincronizados.
