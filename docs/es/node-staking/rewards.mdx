...
El Árbol de Merkle se construye en un archivo JSON y se aloja en [un repositorio de GitHub que mantenemos](https://github.com/rocket-pool/rewards-trees/). El Smartnode también puede cargar los **eventos** de intervalo de recompensas desde ese repositorio de GitHub, por lo que aún puedes reclamar después de que una caducidad agresiva del historial haya descartado los registros antiguos de la capa de Ejecución.
