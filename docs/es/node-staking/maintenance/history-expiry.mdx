...
Los clientes de Ejecución pueden descartar cuerpos de bloque y recibos antiguos para que los datos de la cadena mantengan un tamaño manejable. La configuración **Pruning Mode** del Smart Node (Execution Client → Pruning Mode) controla este comportamiento.
