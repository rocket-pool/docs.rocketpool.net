...
A partir de la versión del Smart Node `v1.15.7`, los usuarios podrán simular el comportamiento de una dirección arbitraria. Mientras se enmascara como otra dirección,
...
Si desea interactuar con el Smart Node a través de la perspectiva de otra dirección de nodo, por favor use el siguiente comando: `rocketpool wallet masquerade`
