...
Dentro del protocolo, el contrato Storage se utiliza para encontrar todas las demás direcciones de contratos desplegados según sea necesario (ver este [ejemplo](/es/overview/contracts-usage#interacting-with-rocket-pool)).
...
Las direcciones se pueden consultar en cadena como se muestra en este [ejemplo](/es/overview/contracts-usage#interacting-with-rocket-pool).
