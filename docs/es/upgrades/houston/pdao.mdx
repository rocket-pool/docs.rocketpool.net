...
Una propuesta debe ser anticipada por el [proceso de gobernanza](../houston/participate#proceso-de-gobernanza) antes de terminar on-chain. Consiste en 4 Períodos, todos los cuales son [parámetros controlables](https://rpips.rocketpool.net/RPIPs/RPIP-33#parameter-table) del pDAO:
...
Después de que la propuesta haya pasado los períodos de votación, el proponente puede [reclamar](../houston/participate#reclamar-bonos-y-recompensas) su bono de RPL bloqueado, a menos que la propuesta haya sido derrotada por un desafío o vetada.
...
Cuando esta configuración está habilitada, el nodo verificará nuevas propuestas, verificará su corrección y enviará desafíos a propuestas inválidas. El único prerrequisito es que el [Bloqueo de RPL](../houston/participate#permitir-el-bloqueo-de-rpl) esté habilitado.
...
Ahora que la propuesta está derrotada, nuestro nodo (el desafiante) puede [reclamar](../houston/participate#reclamar-bonos-y-recompensas) su bono de RPL original así como el bono de RPL del proponente como recompensa por derrotar una propuesta fraudulenta.
