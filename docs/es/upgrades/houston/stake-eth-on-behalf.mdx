...
<div className="p-3">
  <Tabs>
    <Tab label="Preparación en Hoodi Testnet">
      Cuando estés listo para retirar ETH que has depositado en nombre de un nodo, dirígete a [https://testnet.node.rocketpool.net/withdraw-eth](https://testnet.node.rocketpool.net/withdraw-eth). Después de
      iniciar sesión como la [dirección de retiro primaria](../../node-staking/prepare-node#setting-your-primary-withdrawal-address) del nodo, deberías ser recibido con un menú familiar. Se te pedirá que
      ingreses la dirección del nodo del que deseas retirar:
    </Tab>
    <Tab label="Preparación en Ethereum Mainnet">
      Cuando estés listo para retirar ETH que has depositado en nombre de un nodo, dirígete a [https://node.rocketpool.net/withdraw-eth](https://node.rocketpool.net/withdraw-eth). Después de iniciar sesión como la
      [dirección de retiro primaria](../../node-staking/prepare-node#setting-your-primary-withdrawal-address) del nodo, deberías ser recibido con un menú familiar. Se te pedirá que ingreses la dirección del nodo
      del que deseas retirar:
    </Tab>
  </Tabs>
</div>
