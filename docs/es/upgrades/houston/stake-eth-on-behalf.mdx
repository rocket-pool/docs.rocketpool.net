...
Asegúrate de haber configurado correctamente la [dirección de retiro primaria](../../node-staking/prepare-node#establecer-tu-dirección-de-retiro-principal) del nodo que pretendes financiar. Sigue el enlace anterior para obtener una guía sobre cómo funcionan las direcciones de retiro después de Houston.
...
<div className="p-3">
  <Tabs>
    <Tab label="Preparación en Hoodi Testnet">
      ...
      Dirígete a la página [Practicando con la red de prueba](../../node-staking/testnet/overview#obteniendo-eth-de-prueba-en-hoodi) para una guía rápida sobre cómo usar un faucet de testnet para obtener algo de ETH de prueba en Hoodi.
...
<div className="p-3">
  <Tabs>
    <Tab label="Preparación en Hoodi Testnet">
      ...
      Después de iniciar sesión como la [dirección de retiro primaria](../../node-staking/prepare-node#establecer-tu-dirección-de-retiro-principal) del nodo, deberías ser recibido con un menú
      familiar. Se te pedirá que ingreses la dirección del nodo del que deseas retirar:
    </Tab>
    <Tab label="Preparación en Ethereum Mainnet">
      ...
      sesión como la [dirección de retiro primaria](../../node-staking/prepare-node#establecer-tu-dirección-de-retiro-principal) del nodo, deberías ser recibido con un menú familiar. Se te pedirá que
