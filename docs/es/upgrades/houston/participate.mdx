...
Por favor lee el [ciclo de vida de una propuesta](../houston/pdao#ciclo-de-vida-de-una-propuesta-pdao) antes de proceder. Te explicará las diferencias entre todos los períodos de votación y las acciones que se pueden tomar durante cada período.
...
- Si respondes con `delegate`, tendrás la oportunidad de ahorrar un poco de gas al inicializar la votación y [establecer un delegado](../houston/participate#delegar-el-poder-de-voto) dentro de la misma transacción.
...
- Incluido en el snapshotting (ya sea [inicializando la votación](../houston/participate#inicializar-la-votación) o registrándose después de Houston)
- Debe tener al menos un minipool
- Tiene poder de voto no nulo
- Ha permitido el [bloqueo de RPL](../houston/participate#permitir-el-bloqueo-de-rpl)
- Tiene un stake de RPL (menos cualquier RPL ya bloqueado) mayor que el bono de propuesta

¡Las propuestas existen para cambiar parámetros y ejecutar código a nivel de protocolo! Debe haber discusión y consenso a través del proceso de [gobernanza](../houston/participate#proceso-de-gobernanza) antes de que una propuesta se cree on-chain.
...
Después de que esto sea incluido en un bloque, ¡se creará una propuesta pDAO! La propuesta entrará en el [período de retraso de voto](../houston/pdao#período-de-retraso-de-voto) al momento de la creación.
...
<div className="p-3">
  <Tabs>
    <Tab label="Ver una Lista de Propuestas">
      ...
      [los desafiantes](/es/legacy/houston/pdao#proceso-de-desafío) pueden disputar la validez del
      ...
      propuesta](../houston/pdao#ciclo-de-vida-de-una-propuesta-pdao) para un repaso.
    </Tab>
