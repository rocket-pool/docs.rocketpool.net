...
Si vous ne spécifiez pas ce drapeau, le Smartnode tentera de récupérer les clés de validateur pour vos minipools ou vos validateurs de megapool. Cette étape nécessite des clients d'exécution et Beacon synchronisés.
