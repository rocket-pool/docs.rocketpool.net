...
Le Smart Node n'a actuellement pas d'interface graphique (GUI), seulement une interface en ligne de commande (CLI), ce qui signifie que l'interaction se fait entièrement en tapant des commandes dans un terminal en ligne de commande.
