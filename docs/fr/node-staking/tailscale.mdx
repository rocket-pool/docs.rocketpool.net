...
Vous pouvez également supprimer l'accès au port SSH ajouté à partir des étapes d'[activation d'un pare-feu](/fr/node-staking/securing-your-node#essentiel--activer-un-pare-feu) pour verrouiller complètement votre nœud.
