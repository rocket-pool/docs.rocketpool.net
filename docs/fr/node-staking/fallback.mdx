...
Dans cette situation, votre machine de nœud principale sera toujours responsable de l'attestation et de la proposition de blocs avec les clés de validator de vos minipools, mais elle se connectera à une machine externe pour interagir avec les chaînes de couche d'exécution et Beacon.
