...
Depuis la version `v1.15.7` du Smart Node, les utilisateurs pourront simuler le comportement d'une adresse arbitraire. Tout en se faisant passer pour une autre adresse,
...
Si vous souhaitez interagir avec le Smart Node à travers le prisme d'une autre adresse de nœud, veuillez utiliser la commande suivante : `rocketpool wallet masquerade`
