...
Les clients d'exécution peuvent supprimer les anciens corps de blocs et reçus afin que les données de la chaîne conservent une taille gérable. Le paramètre **Pruning Mode** du Smart Node (Execution Client → Pruning Mode) contrôle ce comportement.
