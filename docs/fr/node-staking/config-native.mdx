...
- Via l'[interface du gestionnaire de paramètres](#configuration-via-le-gestionnaire-de-paramètres) - cela vous donne accès à tous les paramètres du Smartnode afin que vous puissiez tout personnaliser autant que vous le souhaitez.
