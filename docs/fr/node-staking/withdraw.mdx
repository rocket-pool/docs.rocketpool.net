...
À ce stade, vous pouvez y accéder en utilisant la CLI Smart Node pour effectuer une distribution.
...
En raison de ces lacunes, la CLI Smart Node **ne prend plus en charge** les retraits ou la distribution de fonds sur le délégué de minipool original.
