...
Bien que l'objectif principal de cette fonctionnalité soit de faciliter les scénarios de déposant unique, il convient de noter que plusieurs déposants indépendants peuvent également tirer parti de cette capacité en créant des contrats intelligents superposés. Rocket Pool a également introduit la possibilité de [miser du RPL au nom](../../node-staking/create-validator#mettre-en-liste-blanche-une-adresse-pour-staker-au-nom-de) d'un nœud lors de notre précédente version Atlas.
...
<div className="p-3">
  <Tabs>
    <Tab label="Préparation sur le Hoodi Testnet">
      ...
      Rendez-vous sur la page [Pratiquer avec le réseau de test](../../node-staking/testnet/overview#obtenir-de-leth-de-test-sur-hoodi) pour un guide rapide sur l'utilisation d'un robinet testnet pour obtenir des ETH de test sur Hoodi.
...
<div className="p-3">
  <Tabs>
    <Tab label="Préparation sur le Hoodi Testnet">
      ...
      menu familier. On vous demandera de saisir l'adresse du nœud duquel vous souhaitez retirer :
    </Tab>
    <Tab label="Préparation sur l'Ethereum Mainnet">
      ...
      On vous demandera de saisir l'adresse du nœud duquel vous souhaitez retirer :
    </Tab>
  </Tabs>
</div>
