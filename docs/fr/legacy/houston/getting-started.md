...
Tout d'abord et avant tout, l'étape la plus importante si vous êtes **opérateur de nœud** est d'[initialiser le vote](../houston/participate#initialiser-le-vote) pour déverrouiller votre pouvoir de vote. Les nœuds qui ont initialisé le vote sont inclus lors du calcul du pouvoir de vote total du réseau.
...
[Définir votre adresse de signalisation Snapshot](../houston/participate#définir-votre-adresse-de-signalisation-snapshot).

### Déléguer le pouvoir de vote on-chain

Si vous souhaitez déléguer le pouvoir de vote on-chain à un membre de la communauté de votre choix, cliquez [ici](../houston/participate#déléguer-le-pouvoir-de-vote) pour apprendre comment.
