...
<div className="p-3">
  <Tabs>
    <Tab label="Préparation sur le Hoodi Testnet">
      ...
      familier. Il vous sera demandé d'entrer l'adresse du nœud depuis lequel vous souhaitez retirer :
    </Tab>
    <Tab label="Préparation sur le Ethereum Mainnet">
      ...
      connecté en tant qu' [adresse de retrait principale](../../node-staking/prepare-node#setting-your-primary-withdrawal-address) du nœud, vous devriez être accueilli par un menu familier. Il vous
      sera demandé d'entrer l'adresse du nœud depuis lequel vous souhaitez retirer :
    </Tab>
  </Tabs>
</div>
