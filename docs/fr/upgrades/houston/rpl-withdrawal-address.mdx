...
Il est important de comprendre la différence entre votre [adresse de retrait principale](../../node-staking/prepare-node#définition-de-votre-adresse-de-retrait-principale) et votre adresse de retrait RPL. Par défaut, votre adresse de retrait RPL n'est pas définie et votre adresse de retrait principale est l'endroit où tous vos récompenses de checkpoint RPL, votre RPL staké et l'ETH de la Beacon Chain seront envoyés.
