...
<div className="p-3">
  <Tabs>
    <Tab label="Lighthouse">
      ...
      - L'[adresse rETH](/fr/protocol/contracts-integrations/#token-contracts) **avant** le déploiement de la mise à jour Redstone (par exemple, `0xae78736Cd615f374D3085123A210448E74Fc6393` sur Mainnet)
      ...
      - L'[adresse du Smoothing Pool](/fr/protocol/contracts-integrations/#protocol-contracts) si vous optez pour le Smoothing Pool
