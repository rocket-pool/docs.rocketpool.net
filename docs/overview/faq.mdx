...
Since the Saturn 0 upgrade, the Rocket Pool protocol no longer requires a minimum amount of RPL. Before Saturn 0, a minimum of 10% of the value in RPL of the ETH provided by the protocol (10% of 24 or 16 ETH respectively, that is, 2.4 or 1.6 ETH) was required.
