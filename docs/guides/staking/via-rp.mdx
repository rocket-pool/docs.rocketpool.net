...
import mm_add_holesky from "./images/mm_add_holesky.png";
...
<div className="p-3">
  <Tabs>
    <Tab label="Preparing on the Holesky Testnet">
      <div className="rspress-directive danger">
        <div className="rspress-directive-title">WARNING</div>
      ...
      <img src={mm_add_holesky} width="100%" height="auto" />
