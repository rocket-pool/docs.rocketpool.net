...
<div className="p-3">
  <Tabs>
    <Tab label="Mainnet">
      [https://node.rocketpool.net/manage/stake-rpl-on-behalf-of-node](https://node.rocketpool.net/manage/stake-rpl-on-behalf-of-node)
    </Tab>
    <Tab label="Holesky Testnet">
      [https://testnet.node.rocketpool.net/manage/stake-rpl-on-behalf-of-node](https://testnet.node.rocketpool.net/manage/stake-rpl-on-behalf-of-node)
    </Tab>
  </Tabs>
</div>
