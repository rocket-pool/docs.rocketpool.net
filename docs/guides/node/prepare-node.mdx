  ...
  <Tabs>
    <Tab label="Method 1">
      **Use this method if your new primary withdrawal address can be used to sign transactions via MetaMask or WalletConnect.**
      ...
      1. The easiest way to do this is to navigate to the Rocket Pool primary withdrawal address site (for the [Hoodi Testnet](https://testnet.node.rocketpool.net/manage/primary-withdrawal-address) or for [Mainnet](https://node.rocketpool.net/manage/primary-withdrawal-address)).
