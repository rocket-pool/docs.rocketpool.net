...
This upgrade consists parameter changes, [Houston Hotfix (RPIP-63)](https://snapshot.org/#/rocketpool-dao.eth/proposal/0x1d75c5247cf457d26fbf7f26622c21de912565256fc3273b92a40aa14dd1af3d)
and [Tokenomics Rework Prelude (RPIP-62)](https://snapshot.org/#/rocketpool-dao.eth/proposal/0x7f6c978251e0ae752c619cc459331e5b3cc081aed13b133159b43fb6194b3304).
:::


## ETH only minipools in Saturn 0 

- The RPL requirement for new minipools are a thing of the past! Minipools launched after the inception of Saturn 0 do not require RPL stake to be deployed. 
...
- Saturn 0 minipools have a 5% base ETH comission, which will be temporarily boosted up to 14% after [Reward Tree Spec v10](https://rpips.rocketpool.net/assets/rpip-62/rewards-calculation-spec), up until the launch of Saturn 1.
...
- Nodes without any RPL stake will be entitled to a 5% base ETH commission.
- Nodes with staked RPL recieve up to a 4% boost for staked RPL valued at >= 10% of borrowed ETH.
- Until Saturn 1, nodes receive a 5% dynamic comission boost.

For a total of up to 14% commission on borrowed ETH. 
