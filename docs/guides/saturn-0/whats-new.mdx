...
::: warning WARNING
Your node must be opted into the [Smoothing Pool](/guides/node/fee-distrib-sp#the-smoothing-pool) to benefit from the dynamic commission boost. The Smart Node will inform you
