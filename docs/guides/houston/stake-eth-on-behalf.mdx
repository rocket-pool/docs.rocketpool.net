...
<div className="p-3">
  <Tabs>
    <Tab label="Preparing on the Hoodi Testnet">
      ...
      Once you have some Hoodi ETH to test with, head to [https://testnet.rocketpool.net/deposit-eth-on-behalf-of-node](https://testnet.rocketpool.net/deposit-eth-on-behalf-of-node).
