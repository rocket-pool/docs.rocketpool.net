...
:::tip NOTE
Whenever a new propsal is created, a voting tree representing a snapshot of the network's voting power and delegate info
...
<div className="p-3">
  <Tabs>
    <Tab label="Holesky Testnet">
      If you're trying this out on Holesky testnet, you can sign on this page:
      https://testnet.rocketpool.net/manage/signalling-address
    </Tab>
    <Tab label="Arbitrum">
      If you're ready to configure this on mainnet, go here instead:
      https://stake.rocketpool.net/manage/signalling-address
    </Tab>
  </Tabs>
</div>
  ...
  <Tabs>
    ...
    <Tab label="Viewing Proposal Details">
      ...
      <div className="rspress-directive tip">
        <div className="rspress-directive-title">NOTE</div>
...
the [rocketpool-research repo](https://github.com/rocket-pool/rocketpool-research/blob/master/pDAO%20Replacement/pDAO.md#overview-of-on-chain-voting).
...
`rocketpool pdao proposal details <proposal-id>` to view the state of the proposal. A proposal needs to reach
  ...
  tool [here](https://stake.rocketpool.net/manage/claim-recurring-payments) to do so. If you're trying this out on
  Holesky
  testnet, use [this](https://testnet.rocketpool.net/manage/stake-rpl-on-behalf-of-node) link instead.
