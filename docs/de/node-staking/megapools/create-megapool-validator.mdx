...
Wenn ein Prelaunch-Validator nicht innerhalb von 365 Tagen stakt, wird der Validator aufgelöst. Der 1 ETH (von einem 4 ETH Bond), der während des Prelaunch-Prozesses an die Beacon Chain gesendet wurde, ist **nicht wiederherstellbar**.
Der Node Operator erhält die verbleibenden 3 ETH aus seinem Bond (abzüglich einer Auflösungsstrafe von 0,05 ETH als Schuld) als Rückerstattung in seinem Megapool, für eine Nettorückerstattung von 2,95 ETH.
