...
Execution-Clients können alte Blockkörper und Belege verwerfen, damit die Chain-Daten eine handhabbare Größe behalten. Die Smart Node-Einstellung **Pruning Mode** (Execution Client → Pruning Mode) steuert dieses Verhalten.
