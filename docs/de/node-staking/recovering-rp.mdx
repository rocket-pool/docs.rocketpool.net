...
Wenn Sie dieses Flag nicht angeben, versucht der Smartnode, die Validator-Schlüssel für Ihre Minipools oder Megapool-Validatoren wiederherzustellen. Dieser Schritt erfordert synchronisierte Execution- und Beacon-Clients.
