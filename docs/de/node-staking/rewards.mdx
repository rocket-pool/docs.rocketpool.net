...
Der Merkle Tree wird in eine JSON-Datei eingebettet und in [einem GitHub-Repository, das wir pflegen](https://github.com/rocket-pool/rewards-trees/), gehostet. Der Smartnode kann die **Events** eines Belohnungsintervalls auch aus diesem GitHub-Repository laden, sodass Sie auch dann noch beanspruchen können, wenn ein aggressiver Ablauf der Historie alte Logs der Execution-Ebene entfernt hat.
