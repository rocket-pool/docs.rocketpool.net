...
Sie können auch den Zugriff auf den SSH-Port aus den [Firewall aktivieren](/de/node-staking/securing-your-node#wesentlich-eine-firewall-aktivieren)-Schritten entfernen, um Ihren Node vollständig abzusichern.
