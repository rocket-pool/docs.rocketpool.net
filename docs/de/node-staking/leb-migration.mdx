...
Beachten Sie, dass ein 8-ETH Minipool mit 14%, wie die [Beispielrechnung](./create-validator.mdx) zeigt, _immer noch profitabler ist_ als ein 16-ETH Minipool mit 20%, sodass das Festhalten an einer hohen Provisionsrate kein überzeugender Grund ist, einen 16 ETH Bond beizubehalten.
:::
...
Sobald Sie einen oder mehrere Minipools zur Reduzierung ausgewählt haben, prüft der Smart Node, ob diese Minipools für eine Bond Reduction berechtigt sind.
...
Dieses Guthaben kann verwendet werden, um [einen weiteren 8-ETH Minipool zu erstellen](./create-validator.mdx#einzahlen-von-eth-und-erstellen-eines-minipools) - kostenlos (kein ETH aus der Node-Wallet erforderlich, außer für Gas)!
