...
Ab Smart Node-Version `v1.15.7` können Benutzer das Verhalten einer beliebigen Adresse simulieren. Während Sie sich als eine andere Adresse maskieren,
...
Wenn Sie mit dem Smart Node aus der Perspektive einer anderen Node-Adresse interagieren möchten, verwenden Sie bitte folgenden Befehl: `rocketpool wallet masquerade`
