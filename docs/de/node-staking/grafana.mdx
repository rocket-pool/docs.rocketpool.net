...
Wenn Sie nach der Dashboard-ID im Feld **Import via grafana.com** gefragt werden, geben Sie `21863` ein oder verwenden Sie die vollständige URL ([(https://grafana.com/grafana/dashboards/24900-rocket-pool-dashboard-v1-4-0/](https://grafana.com/grafana/dashboards/24900-rocket-pool-dashboard-v1-4-0/)) und klicken Sie auf die Schaltfläche **Load**.
