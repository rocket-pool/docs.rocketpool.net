...
<div className="p-3">
  <Tabs>
    <Tab label="Vorbereitung im Hoodi Testnet">
      ...
      der Anmeldung als [primäre Withdrawal-Adresse](../../node-staking/prepare-node#setting-your-primary-withdrawal-address) des Nodes sollten Sie mit einem vertrauten Menü begrüßt werden. Sie werden aufgefordert,
    ...
    <Tab label="Vorbereitung im Ethereum Mainnet">
      ...
      [primäre Withdrawal-Adresse](../../node-staking/prepare-node#setting-your-primary-withdrawal-address) des Nodes sollten Sie mit einem vertrauten Menü begrüßt werden. Sie werden aufgefordert, die Node-Adresse
