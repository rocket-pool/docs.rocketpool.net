...
Bitte lesen Sie den [Lebenszyklus eines Vorschlags](/de/legacy/houston/pdao#lifecycle-of-a-pdao-proposal), bevor Sie fortfahren. Er erklärt die Unterschiede zwischen allen Abstimmungsperioden und den Aktionen, die während jeder Periode durchgeführt werden können.
...
- Wenn Sie mit `delegate` antworten, haben Sie die Möglichkeit, etwas Gas zu sparen, indem Sie die Abstimmung initialisieren und [einen Delegierten festlegen](/de/legacy/houston/participate#delegating-voting-power) innerhalb derselben Transaktion.
...
- Im Snapshotting enthalten (entweder durch [Abstimmung initialisieren](/de/legacy/houston/participate#initializing-voting) oder durch Registrierung nach Houston)
- Muss mindestens einen Minipool haben
- Hat eine von Null verschiedene Abstimmungskraft
- Hat [RPL-Sperrung erlaubt](/de/legacy/houston/participate#allowing-rpl-locking)
- Hat einen RPL-Stake (abzüglich bereits gesperrtem RPL), der größer ist als die Vorschlagsbindung

Vorschläge existieren, um Parameter zu ändern und Code auf Protokollebene auszuführen! Es sollte Diskussion und Konsens durch den [Governance](/de/legacy/houston/participate#governance-process)-Prozess geben, bevor ein Vorschlag on-chain erstellt wird.
