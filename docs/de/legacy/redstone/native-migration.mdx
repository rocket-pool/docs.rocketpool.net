...
Wie im [Übersichtsartikel](./whats-new#fee-recipients-und-ihr-distributor) beschrieben, kann dies einer von zwei Werten sein:
...
<div className="p-3">
  <Tabs>
    <Tab label="Lighthouse">
      ...
      - Die [Smoothing Pool-Adresse](/de/protocol/contracts-integrations/#wichtige-protokoll-contracts), wenn Sie dem Smoothing Pool beitreten
