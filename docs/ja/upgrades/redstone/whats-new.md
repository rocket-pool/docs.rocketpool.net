...
- 報酬はチェックポイント時ではなく*請求時*に決定されました。ユーザーがチェックポイントと請求の間に大量のRPLをステークした場合、報酬が希薄化され、予想よりも少ないRPLを受け取る可能性がありました。

*新しい*請求システムはこれらすべての問題を解決します。
...
::: danger 警告
*スナップショット時*に10%未満のRPL担保である場合、そのスナップショットの報酬を受け取る資格がありません。
