...
2026年5月現在、価格が手頃でパフォーマンスの高いオプションの1つは、[Netcup](https://www.netcup.eu/vserver/vps.php)のRS 12000 G12でした。
...
2026年5月現在、価格が手頃でパフォーマンスの高いオプションは、[OVH](https://us.ovhcloud.com/)のRiseとAdvanceベアメタルサーバーでした。これらは時間とともに変化するさまざまなバリエーションがあり、大幅なセールもあります。[ハードウェアガイドライン](../local/hardware.md)を満たしていることを確認する必要があります。
...
以下のセクションでは、コスト見積もりのより詳細な内訳がありますが、VPSオプションと専用サーバーオプションの一般的な比較は次のとおりです。
