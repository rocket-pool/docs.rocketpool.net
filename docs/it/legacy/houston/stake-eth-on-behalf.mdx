...
<div className="p-3">
  <Tabs>
    <Tab label="Preparazione su Hoodi Testnet">
      ...
      aver effettuato l'accesso come [indirizzo di prelievo primario](../../node-staking/prepare-node#setting-your-primary-withdrawal-address) del nodo, dovresti essere accolto con un menu familiare.
      Ti verrà chiesto di inserire l'indirizzo del nodo da cui vuoi prelevare:
    </Tab>
    <Tab label="Preparazione su Ethereum Mainnet">
      ...
      l'accesso come [indirizzo di prelievo primario](../../node-staking/prepare-node#setting-your-primary-withdrawal-address) del nodo, dovresti essere accolto con un menu familiare. Ti verrà chiesto
      di inserire l'indirizzo del nodo da cui vuoi prelevare:
    </Tab>
  </Tabs>
</div>
