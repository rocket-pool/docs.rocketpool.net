...
<div className="p-3">
  <Tabs>
    <Tab label="Preparazione sulla Hoodi Testnet">
      ...
      primario](../../node-staking/prepare-node#setting-your-primary-withdrawal-address) del nodo, dovresti essere accolto con un menu familiare. Ti verrà richiesto di inserire l'indirizzo del nodo da
      cui vuoi prelevare:
    </Tab>
    <Tab label="Preparazione sulla Ethereum Mainnet">
      ...
      effettuato l'accesso come [indirizzo di prelievo primario](../../node-staking/prepare-node#setting-your-primary-withdrawal-address) del nodo, dovresti essere accolto con un menu familiare. Ti
      verrà richiesto di inserire l'indirizzo del nodo da cui vuoi prelevare:
    </Tab>
  </Tabs>
</div>
