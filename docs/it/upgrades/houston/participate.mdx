...
Leggi il [ciclo di vita di una proposta](../houston/pdao#lifecycle-of-a-pdao-proposal) prima di procedere. Spiegherà le differenze tra tutti i periodi di voto e le azioni che possono essere intraprese durante ciascun periodo.
...
- Incluso nello snapshotting (o [inizializzando il voto](../houston/participate#initializing-voting) o registrandosi post Houston)
- Deve avere almeno un minipool
- Ha un potere di voto diverso da zero
- Ha consentito il [blocco di RPL](../houston/participate#allowing-rpl-locking)
...
<div className="p-3">
  <Tabs>
    <Tab label="Visualizzare un Elenco di Proposte">
      ...
      i [challengers](/it/legacy/houston/pdao#challenge-process) possono contestare la validità del
      ...
      proposta](../houston/pdao#lifecycle-of-a-pdao-proposal) per un ripasso.
    </Tab>
