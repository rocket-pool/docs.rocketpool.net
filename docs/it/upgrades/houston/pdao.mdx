...
Una proposta dovrebbe essere prevista dal [processo di governance](../houston/participate#processo-di-governance) prima di finire on-chain. Consiste di 4 Periodi, tutti [parametri controllabili](https://rpips.rocketpool.net/RPIPs/RPIP-33#parameter-table) dal pDAO:
...
Dopo che la proposta ha superato i periodi di voto, il proponente può [richiedere](../houston/participate#richiedere-bond-e-ricompense) il suo bond RPL bloccato, a meno che la proposta non sia stata sconfitta da una sfida o vetata.
...
Qualsiasi nodo può partecipare al monitoraggio e alla verifica della correttezza delle proposte. Per partecipare a questa responsabilità, usa il comando `rocketpool service config`, naviga nel menu **Smart Node and TX Fee Settings** e seleziona la casella `Enable PDAO Proposal Checker`.

<img src={proposal_checker} width="100%" height="auto" />

Quando questa impostazione è abilitata, il nodo verificherà nuove proposte, ne verificherà la correttezza e invierà sfide a proposte non valide. L'unico prerequisito è che il [Blocco RPL](../houston/participate#consentire-il-blocco-di-rpl) sia abilitato.
...
Ora che la proposta è sconfitta, il nostro nodo (lo sfidante) può [richiedere](../houston/participate#richiedere-bond-e-ricompense) il suo bond RPL originale e il bond RPL del proponente come ricompensa per aver sconfitto una proposta fraudolenta.
