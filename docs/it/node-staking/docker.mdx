...
In questa sezione, illustreremo il processo di installazione dello stack Smartnode di Rocket Pool utilizzando la configurazione standard basata su [Docker](https://www.docker.com/resources/what-container).
Questo installerà e configurerà tutto il necessario per eseguire un nodo completo, incluso:
