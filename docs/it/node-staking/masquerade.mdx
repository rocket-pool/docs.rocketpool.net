...
A partire dalla versione Smart Node `v1.15.7`, gli utenti saranno in grado di simulare il comportamento di un indirizzo arbitrario. Mentre impersoni un altro indirizzo,
...
Se desideri interagire con lo Smart Node attraverso la lente di un altro indirizzo nodo, utilizza il seguente comando: `rocketpool wallet masquerade`
