...
Quando ti viene richiesto l'ID del dashboard nella casella **Import via grafana.com**, inserisci `21863` o usa l'URL completo ([(https://grafana.com/grafana/dashboards/24900-rocket-pool-dashboard-v1-4-0/](https://grafana.com/grafana/dashboards/24900-rocket-pool-dashboard-v1-4-0/)) e premi il pulsante **Load**.
