...
Lo Smart Node attualmente non ha una GUI (Interfaccia Grafica Utente), solo una CLI (Interfaccia a Riga di Comando), il che significa che interagire con esso avviene interamente digitando comandi in un terminale a riga di comando.
