...
Puoi anche rimuovere l'accesso alla porta SSH aggiunta dai passaggi di [abilitazione di un firewall](/it/node-staking/securing-your-node#essenziale-abilitare-un-firewall) per bloccare completamente il tuo nodo.
