...
I client Execution possono eliminare vecchi corpi dei blocchi e ricevute in modo che i dati della chain mantengano una dimensione gestibile. L'impostazione **Pruning Mode** dello Smart Node (Execution Client → Pruning Mode) controlla questo comportamento.
