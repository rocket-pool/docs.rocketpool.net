...
A questo punto, puoi accedervi usando la Smart Node CLI per effettuare una distribuzione.
...
A differenza della [distribuzione manuale](./skimming#distribuzione-manuale), questo processo **finalizzerà** effettivamente il tuo minipool, chiudendolo e rendendolo inattivo.
...
A causa di queste carenze, la Smart Node CLI **non supporta più** prelievi o distribuzione di fondi sul delegate originale del minipool.
