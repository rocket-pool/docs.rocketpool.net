...
Se non specifichi questo flag, lo Smartnode tenterà di recuperare le chiavi dei validator per i tuoi minipool o per i validator del megapool. Questo passaggio richiede client Execution e Beacon sincronizzati.
