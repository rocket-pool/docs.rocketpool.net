...
Se você não especificar esta flag, o Smartnode tentará recuperar as chaves de validador para seus minipools ou validadores de megapool. Esse passo precisa de clientes Execution e Beacon sincronizados.
