...
- Via [Interface do Gerenciador de Configurações](#configurando-via-gerenciador-de-configurações) - isso oferece acesso a todas as configurações do Smartnode para que você possa personalizar tudo o quanto quiser.
...
::: tip NOTA
Se você já configurou o Smartnode, em vez disso, você será recebido com o [Gerenciador de Configurações](#configurando-via-gerenciador-de-configurações).
