...
Confira o guia [Visualizando suas recompensas de ETH e RPL](/pt/node-staking/megapools/staking-and-claiming-rewards#visualizando-as-recompensas-de-eth-e-rpl-do-seu-nó) para aprender sobre os diferentes tipos
de recompensas que você pode ganhar e como verificar o status das suas recompensas.

Depois de familiarizar-se com isso, leia [Resgatando Recompensas](/pt/node-staking/megapools/staking-and-claiming-rewards#resgatando-as-recompensas-de-eth-e-rpl-do-seu-nó) para aprender como resgatar suas recompensas.
...
Para migrar seu RPL legado, você primeiro [Fará o Unstake e Retirará](/pt/node-staking/megapools/staking-and-claiming-rewards#unstaking-e-retirada-de-rpl) seu RPL legado, depois [fará stake](/pt/node-staking/megapools/staking-and-claiming-rewards#staking) novamente usando o comando `rocketpool node stake-rpl`. Explicaremos como
...
[encerrar seu(s) minipool(s)](/pt/node-staking/withdraw#encerrar-um-minipool) para reduzir o valor do seu colateral de ETH emprestado.
