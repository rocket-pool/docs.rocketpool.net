...
A partir da versão `v1.15.7` do Smart Node, os usuários poderão simular o comportamento de um endereço arbitrário. Enquanto disfarçado como outro endereço,
...
Se você deseja interagir com o Smart Node através da perspectiva de outro endereço de nó, use o seguinte comando: `rocketpool wallet masquerade`
