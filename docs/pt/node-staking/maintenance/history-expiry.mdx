...
Os clientes de Execução podem descartar corpos de bloco e recibos antigos para que os dados da cadeia mantenham um tamanho gerenciável. A configuração **Pruning Mode** do Smart Node (Execution Client → Pruning Mode) controla esse comportamento.
