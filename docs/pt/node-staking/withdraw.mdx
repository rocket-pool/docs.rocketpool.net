...
Neste ponto, você pode acessá-lo usando a CLI do Smart Node para fazer uma distribuição.
...
Diferentemente da [distribuição manual](./skimming#distribuição-manual), este processo irá realmente **finalizar** seu minipool, o que o fecha e o torna inativo.
...
Devido a essas deficiências, a CLI do Smart Node **não suporta mais** retiradas ou distribuição de fundos no delegado de minipool original.
