...
- Via [Interface do Gerenciador de Configurações](#configurando-via-o-gerenciador-de-configurações) - isso dá acesso a todas as configurações da Smartnode para que você possa personalizar tudo o quanto quiser.
...
::: tip NOTA
Se você já configurou a Smartnode, será recebido com o [Gerenciador de Configurações](#configurando-via-o-gerenciador-de-configurações).
