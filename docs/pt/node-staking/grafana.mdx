...
Quando solicitado para o ID do dashboard na caixa **Import via grafana.com**, digite `21863` ou use a URL completa ([(https://grafana.com/grafana/dashboards/24900-rocket-pool-dashboard-v1-4-0/](https://grafana.com/grafana/dashboards/24900-rocket-pool-dashboard-v1-4-0/)) e pressione o botão **Load**.
