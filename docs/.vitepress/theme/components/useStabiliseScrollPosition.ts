...
type StabiliseScrollPosition = <Args extends readonly unknown[], Return>(func: (...args: Args) => Return) => (...args: Args) => Promise<Return>;

export const useStabiliseScrollPosition = (targetEle: Ref<HTMLElement | undefined>) => {
