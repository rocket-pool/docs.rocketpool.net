...
::: tip 提示
如果您希望让 Smartnode 维护自己的执行客户端和共识客户端，但想保持对自己验证器客户端的控制（例如，如果您有自己的单独质押验证器密钥附加到它），您可能想要考虑 [反向混合模式](../../node-staking/advanced-config#allowing-external-validator-clients-to-connect-to-the-smartnode)，它正好做到这一点！
:::
