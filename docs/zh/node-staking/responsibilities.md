...
这意味着,与 Proof of Work 中矿工除非找到下一个区块否则不保证获得区块奖励不同,Proof of Stake validators _保证_只要他们履行职责就能获得稳定的收入。
...
幸运的是,Rocket Pool 最核心的原则之一是_去中心化_——任何人,在任何地方,只要有决心和知识,都可以运行节点。
虽然我们无法帮助决心,但我们_可以_帮助知识。
