...
所有执行客户端现在都支持符合 [EIP-4444](https://eips.ethereum.org/EIPS/eip-4444) 的部分历史过期。从 Smartnode 版本 `v1.17.0` 开始，用户可以通过删除合并前的区块历史来大幅减少节点的存储需求。请随意查看
...
<div className="p-3">
  <Tabs>
    ...
    <Tab label="Geth">
        ...
        ```
        您可以单击[此处](/zh/node-staking/pruning#starting-a-prune)了解有关修剪的更多信息。
