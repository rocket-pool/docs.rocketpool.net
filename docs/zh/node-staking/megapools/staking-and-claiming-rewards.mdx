...
查看[查看您的 ETH 和 RPL 奖励](/zh/node-staking/megapools/staking-and-claiming-rewards#查看您节点的-eth-和-rpl-奖励)指南，了解您可以赚取的不同类型奖励，以及如何检查您的奖励状态。

熟悉之后，请阅读[领取奖励](/zh/node-staking/megapools/staking-and-claiming-rewards#领取您节点的-eth-和-rpl-奖励)，了解如何领取您的奖励。
...
要迁移您的旧版 RPL，您首先需要[取消质押并提取](/zh/node-staking/megapools/staking-and-claiming-rewards#取消质押和提取-rpl)您的旧版 RPL，然后使用 `rocketpool node stake-rpl` 命令再次[质押](/zh/node-staking/megapools/staking-and-claiming-rewards#质押)。我们将在下一节介绍如何操作。
...
[退出您的 minipool](/zh/node-staking/withdraw#关闭-minipool) 以降低您的借入 ETH 抵押金额。
