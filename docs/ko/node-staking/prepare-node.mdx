...
<div className="p-3">
  <Tabs>
    <Tab label="Running on the Hoodi Test Network">
      f you're running on the Hoodi test network, please see the [Practicing with the Test Network](/en/testnet/overview) section to learn how to acquire test ETH.

      For test RPL, we have added a similar faucet function directly to the CLI.
      Please see the [Getting Test RPL on Hoodi](/en/testnet/overview#getting-test-rpl-on-hoodi) guide to acquire some.
    </Tab>
