...
그렇지 않은 경우 [fee distributor contract](./whats-new#수수료-수신자-및-분배자)가 fee recipient가 됩니다.
...
[Smoothing Pool](./whats-new#smoothing-pool)에 가입하지 않고 모든 우선 수수료 및 MEV 보상을 [fee distributor contract](./whats-new#수수료-수신자-및-분배자)로 청구하려는 경우, 출금 주소로 보상을 청구하려면 결국 초기화(체인에 계약 인스턴스 생성)해야 합니다.
