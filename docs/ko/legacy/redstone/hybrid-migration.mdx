...
::: tip 팁
Smartnode가 자체 Execution 및 Consensus client를 유지하도록 하면서 자체 Validator client를 제어하고 싶다면(예: 자체 solo staking validator 키가 연결되어 있는 경우), 정확히 이를 수행하는 [Reverse Hybrid Mode](../../node-staking/advanced-config#외부-검증자-클라이언트의-smartnode-연결-허용)를 고려할 수 있습니다!
:::
