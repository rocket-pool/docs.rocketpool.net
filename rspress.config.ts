...
const sidebarTranslations: Record<string, SidebarTranslation> = {
  en: {
    ...
    nodeStaking: {
      ...
      configDocker: "Configuring the Smart Node Stack (Docker/hybrid mode)",
      configNative: "Configuring the Smart Node Stack (native)",
      advancedConfig: "Advanced Smart Node Configuration for Docker Mode",
      ...
      alerting: "Smart Node Stack Alert Notifications",
    ...
    legacy: {
      title: "Legacy Guides",
      v13Update: "Upgrading to Smart Node v1.3.x",
      migrating: "Migrating the Smart Node from Previous Beta Tests",
      atlas: "The Atlas Update",
      lebs: "Lower ETH Bond Minipools",
      redstone: "Redstone & The Merge",
      redstoneWhatsNew: "The Rocket Pool Redstone Update",
  ...
  zh: {
    ...
    nodeStaking: {
      ...
      configOverview: "概述",
      configDocker: "配置 Smart Node 栈 (Docker/混合模式)",
      configNative: "配置 Smart Node 栈 (原生模式)",
      advancedConfig: "Docker 模式高级 Smart Node 配置",
      provisioning: "配置您的节点",
    ...
    legacy: {
      title: "旧版指南",
      v13Update: "升级到 Smart Node v1.3.x",
      migrating: "从之前的 Beta 测试迁移 Smart Node",
      atlas: "Atlas 更新",
      lebs: "低 ETH 保证金 Minipools",
      redstone: "Redstone 与合并",
      redstoneWhatsNew: "Rocket Pool Redstone 更新",
  ...
  es: {
    ...
    nodeStaking: {
      ...
      configDocker: "Configurando el Stack Smart Node (modo Docker/híbrido)",
      configNative: "Configurando el Stack Smart Node (nativo)",
      advancedConfig: "Configuración Avanzada de Smart Node para Modo Docker",
      ...
      alerting: "Notificaciones de Alerta del Stack Smart Node",
    ...
    legacy: {
      ...
      v13Update: "Actualizando a Smart Node v1.3.x",
      migrating: "Migrando el Smart Node desde Pruebas Beta Anteriores",
      atlas: "La Actualización Atlas",
  ...
  fr: {
    ...
    nodeStaking: {
      ...
      configDocker: "Configurer la Stack Smart Node (mode Docker/hybride)",
      configNative: "Configurer la Stack Smart Node (natif)",
      advancedConfig: "Configuration Avancée Smart Node pour Mode Docker",
      ...
      alerting: "Notifications d'Alerte de la Stack Smart Node",
    ...
    legacy: {
      ...
      v13Update: "Mise à niveau vers Smart Node v1.3.x",
      migrating: "Migration du Smart Node depuis les Tests Bêta Précédents",
      atlas: "La Mise à Jour Atlas",
  ...
  de: {
    ...
    nodeStaking: {
      ...
      configDocker: "Den Smart Node-Stack konfigurieren (Docker/Hybrid-Modus)",
      configNative: "Den Smart Node-Stack konfigurieren (nativ)",
      advancedConfig: "Erweiterte Smart Node-Konfiguration für Docker-Modus",
      ...
      alerting: "Smart Node-Stack-Benachrichtigungen",
    ...
    legacy: {
      ...
      v13Update: "Upgrade auf Smart Node v1.3.x",
      migrating: "Smart Node von früheren Beta-Tests migrieren",
      atlas: "Das Atlas-Update",
  ...
  ja: {
    ...
    nodeStaking: {
      ...
      configOverview: "概要",
      configDocker: "Smart Nodeスタックの設定 (Docker/ハイブリッドモード)",
      configNative: "Smart Nodeスタックの設定 (ネイティブ)",
      advancedConfig: "Dockerモード用高度なSmart Node設定",
    ...
    legacy: {
      title: "レガシーガイド",
      v13Update: "Smart Node v1.3.xへのアップグレード",
      migrating: "以前のベータテストからのSmart Node移行",
      atlas: "Atlasアップデート",
  ...
  ko: {
    ...
    nodeStaking: {
      ...
      configOverview: "개요",
      configDocker: "Smart Node 스택 구성 (Docker/하이브리드 모드)",
      configNative: "Smart Node 스택 구성 (네이티브)",
      advancedConfig: "Docker 모드용 고급 Smart Node 구성",
    ...
    legacy: {
      title: "레거시 가이드",
      v13Update: "Smart Node v1.3.x로 업그레이드",
      migrating: "이전 베타 테스트에서 Smart Node 마이그레이션",
      atlas: "Atlas 업데이트",
  ...
  pt: {
    ...
    nodeStaking: {
      ...
      configDocker: "Configurando a Stack Smart Node (modo Docker/híbrido)",
      configNative: "Configurando a Stack Smart Node (nativo)",
      advancedConfig: "Configuração Avançada do Smart Node para Modo Docker",
      provisioning: "Provisionando Seu Nó",
      provisioningOverview: "Visão Geral",
      startingRp: "Iniciando o Rocket Pool",
      walletInit: "Criando uma Nova Carteira",
      recovering: "Importando/Recuperando uma Carteira Existente",
      prepareNode: "Preparando Seu Nó para Operação",
      ...
      maintenance: "Monitoramento e Manutenção",
      maintenanceOverview: "Visão Geral",
      performance: "Monitorando o Desempenho do Seu Nó",
      grafana: "Configurando o Painel Grafana",
      alerting: "Notificações de Alerta da Stack Smart Node",
      ...
      changeClients: "Alterando Clientes de Execução ou Consenso",
      nodeMigration: "Movendo de um Nó para Outro",
      rewards: "Reivindicando Recompensas",
      rewardsOverview: "Visão Geral",
      claimingRewards: "Reivindicando Recompensas de Operador de Nó",
      skimming: "Distribuindo Recompensas Desnatadas",
      exiting: "Saindo dos Seus Minipools",
      shutdown: "Encerrar um Minipool",
      faq: "FAQ (Em andamento)",
    },
    odao: {
      title: "Oracle DAO",
      overview: "O Oracle DAO do Rocket Pool",
      setup: "Configurando um Nó Oracle DAO",
      testing: "Testando seu Nó Oracle DAO",
      monitoring: "Monitorando seu Nó Oracle DAO",
      proposals: "Propostas do Oracle DAO",
    },
    pdao: { title: "Protocolo DAO", overview: "Visão Geral", pdao: "O Protocolo DAO", participating: "Participando de Propostas" },
    upgrades: {
      title: "Atualizações do Protocolo",
      saturn1: "A Atualização Saturn 1",
      saturn0: "A Atualização Saturn 0",
      houston: "A Atualização Houston",
      houstonOverview: "Visão Geral",
      houstonGettingStarted: "Começando com Houston",
      houstonPdao: "O Protocolo DAO",
      atlas: "A Atualização Atlas",
      lebs: "Minipools de Baixo ETH Bond",
      redstone: "Redstone e The Merge",
      redstoneWhatsNew: "A Atualização Rocket Pool Redstone",
      redstoneDocker: "[Modo Docker] Guia da Atualização Redstone e The Merge",
    ...
    legacy: {
      title: "Guias Antigos",
      v13Update: "Atualizando para Smart Node v1.3.x",
      migrating: "Migrando o Smart Node de Testes Beta Anteriores",
      atlas: "A Atualização Atlas",
      lebs: "Minipools com Menor Garantia ETH",
      redstone: "Redstone e The Merge",
      redstoneWhatsNew: "A Atualização Redstone do Rocket Pool",
      redstoneDocker: "[Modo Docker] Guia da Atualização Redstone e The Merge",
      redstoneHybrid: "[Modo Híbrido] Guia da Atualização Redstone e The Merge",
      redstoneNative: "[Modo Nativo] Guia da Atualização Redstone e The Merge",
      houston: "A Atualização Houston",
      ...
      houstonGettingStarted: "Começando com Houston",
      houstonPdao: "O Protocolo DAO",
      houstonParticipate: "Participando de Propostas",
      houstonStakeOnBehalf: "Fazer Stake de ETH em Nome do Nó",
      houstonRplWithdrawal: "Endereço de Saque de RPL",
      preparePi: "Preparando um Raspberry Pi",
    },
  },
  ru: {
    ...
    liquidStaking: {
      title: "Ликвидный стейкинг (rETH)",
      overview: "Обзор",
      viaRp: "Стейкинг напрямую через Rocket Pool",
      viaL1: "Стейкинг через DEX на Layer 1",
      viaL2: "Стейкинг через DEX на Layer 2",
      onBehalf: "Стейкинг от имени ноды",
    },
    nodeStaking: {
      title: "Руководство оператора ноды",
      responsibilities: "Обязанности оператора ноды",
      platform: "Требования к ноде и выбор платформы",
      localNode: "Подготовка локальной ноды",
      localOverview: "Обзор",
      hardware: "Выбор оборудования для стейкинга",
      preparePC: "Подготовка ПК, мини-ПК или NUC",
      prepareMac: "Подготовка Mac",
      ssh: "Введение в Secure Shell (SSH)",
      serverNode: "Подготовка серверной ноды",
      serverOverview: "Обзор",
      providers: "Выбор хостинг-провайдера",
      serverOS: "Подготовка операционной системы",
      securing: "Защита вашей ноды",
      tailscale: "Tailscale",
      installing: "Установка Rocket Pool",
      installOverview: "Обзор",
      ethClients: "Выбор ETH-клиентов",
      installModes: "Выбор режима Rocket Pool",
      docker: "Создание стандартной ноды Rocket Pool с Docker",
      native: "Создание нативной ноды Rocket Pool без Docker",
      configuring: "Настройка Rocket Pool",
      configOverview: "Обзор",
      configDocker: "Настройка стека Smart Node (режим Docker/гибридный)",
      configNative: "Настройка стека Smart Node (нативный)",
      advancedConfig: "Расширенная настройка Smart Node для режима Docker",
      provisioning: "Подготовка вашей ноды",
      provisioningOverview: "Обзор",
      startingRp: "Запуск Rocket Pool",
      walletInit: "Создание нового кошелька",
      recovering: "Импорт/восстановление существующего кошелька",
      prepareNode: "Подготовка ноды к работе",
      cliIntro: "Введение в командную строку",
      ...
      maintenance: "Мониторинг и обслуживание",
      maintenanceOverview: "Обзор",
      performance: "Мониторинг производительности ноды",
      grafana: "Настройка панели Grafana",
      alerting: "Уведомления стека Smart Node",
      ...
      changeClients: "Смена клиентов исполнения или консенсуса",
      nodeMigration: "Переход с одной ноды на другую",
      rewards: "Получение вознаграждений",
      rewardsOverview: "Обзор",
      claimingRewards: "Получение вознаграждений оператора ноды",
      skimming: "Распределение снятых вознаграждений",
      exiting: "Выход из Minipool",
      shutdown: "Закрытие Minipool",
      faq: "FAQ (В процессе)",
    },
    odao: {
      title: "Oracle DAO",
      overview: "Rocket Pool Oracle DAO",
      setup: "Настройка ноды Oracle DAO",
      testing: "Тестирование ноды Oracle DAO",
      monitoring: "Мониторинг ноды Oracle DAO",
      proposals: "Предложения Oracle DAO",
    },
    pdao: { title: "Протокол DAO", overview: "Обзор", pdao: "Протокол DAO", participating: "Участие в предложениях" },
    upgrades: {
      title: "Обновления протокола",
      saturn1: "Обновление Saturn 1",
      saturn0: "Обновление Saturn 0",
      houston: "Обновление Houston",
      houstonOverview: "Обзор",
      houstonGettingStarted: "Начало работы с Houston",
      houstonPdao: "Протокол DAO",
      atlas: "Обновление Atlas",
      lebs: "Minipools с низким залогом ETH",
      redstone: "Redstone и слияние",
      redstoneWhatsNew: "Обновление Rocket Pool Redstone",
      redstoneDocker: "[Режим Docker] Руководство по обновлению Redstone и слиянию",
      redstoneHybrid: "[Гибридный режим] Руководство по обновлению Redstone и слиянию",
      redstoneNative: "[Нативный режим] Руководство по обновлению Redstone и слиянию",
    },
    ...
    legacy: {
      ...
      v13Update: "Обновление до Smart Node v1.3.x",
      migrating: "Миграция Smart Node с предыдущих бета-тестов",
      atlas: "Обновление Atlas",
      lebs: "Minipool с низким залогом ETH",
      redstone: "Redstone и слияние",
      redstoneWhatsNew: "Обновление Rocket Pool Redstone",
      redstoneDocker: "[Режим Docker] Руководство по обновлению Redstone и слиянию",
      redstoneHybrid: "[Гибридный режим] Руководство по обновлению Redstone и слиянию",
      ...
      houstonGettingStarted: "Начало работы с Houston",
      houstonPdao: "Протокол DAO",
      houstonParticipate: "Участие в предложениях",
      houstonStakeOnBehalf: "Стейкинг ETH от имени ноды",
      houstonRplWithdrawal: "Адрес вывода RPL",
      preparePi: "Подготовка Raspberry Pi",
    },
  },
  it: {
    ...
    liquidStaking: {
      title: "Liquid Staking (rETH)",
      overview: "Panoramica",
      viaRp: "Staking diretto via Rocket Pool",
      viaL1: "Staking via DEX su Layer 1",
      viaL2: "Staking via DEX su Layer 2",
      onBehalf: "Staking per conto di un nodo",
    },
    nodeStaking: {
      title: "Guida dell'Operatore di Nodo",
      responsibilities: "Responsabilità dell'Operatore di Nodo",
      platform: "Requisiti del Nodo e Scelta della Piattaforma",
      localNode: "Preparare un Nodo Locale",
      localOverview: "Panoramica",
      hardware: "Selezione dell'Hardware per lo Staking",
      preparePC: "Preparare un PC, Mini-PC o NUC",
      prepareMac: "Preparare un Mac",
      ssh: "Introduzione a Secure Shell (SSH)",
      serverNode: "Preparare un Nodo Server",
      serverOverview: "Panoramica",
      providers: "Selezione di un Provider di Hosting",
      serverOS: "Preparazione del Sistema Operativo",
      securing: "Proteggere il Tuo Nodo",
      tailscale: "Tailscale",
      installing: "Installazione di Rocket Pool",
      installOverview: "Panoramica",
      ethClients: "Scelta dei Client ETH",
      installModes: "Selezione di una Modalità Rocket Pool",
      docker: "Creazione di un Nodo Rocket Pool Standard con Docker",
      native: "Creazione di un Nodo Rocket Pool Nativo senza Docker",
      configuring: "Configurazione di Rocket Pool",
      configOverview: "Panoramica",
      configDocker: "Configurazione dello Stack Smart Node (modalità Docker/ibrida)",
      configNative: "Configurazione dello Stack Smart Node (nativo)",
      advancedConfig: "Configurazione Avanzata Smart Node per Modalità Docker",
      provisioning: "Provisioning del Tuo Nodo",
      provisioningOverview: "Panoramica",
      startingRp: "Avvio di Rocket Pool",
      walletInit: "Creazione di un Nuovo Portafoglio",
      recovering: "Importazione/Recupero di un Portafoglio Esistente",
      prepareNode: "Preparazione del Nodo per l'Operazione",
      cliIntro: "Introduzione all'Interfaccia a Riga di Comando",
      ...
      maintenance: "Monitoraggio e Manutenzione",
      maintenanceOverview: "Panoramica",
      performance: "Monitoraggio delle Prestazioni del Nodo",
      grafana: "Configurazione della Dashboard Grafana",
      alerting: "Notifiche di Avviso dello Stack Smart Node",
      ...
      changeClients: "Cambio dei Client di Esecuzione o Consenso",
      nodeMigration: "Passaggio da un Nodo all'Altro",
      rewards: "Richiesta delle Ricompense",
      rewardsOverview: "Panoramica",
      claimingRewards: "Richiesta delle Ricompense dell'Operatore di Nodo",
      skimming: "Distribuzione delle Ricompense Scremate",
      exiting: "Uscita dai Tuoi Minipool",
      shutdown: "Chiusura di un Minipool",
      faq: "FAQ (In corso)",
    },
    odao: {
      title: "Oracle DAO",
      overview: "L'Oracle DAO di Rocket Pool",
      setup: "Configurazione di un Nodo Oracle DAO",
      testing: "Test del Tuo Nodo Oracle DAO",
      monitoring: "Monitoraggio del Tuo Nodo Oracle DAO",
      proposals: "Proposte dell'Oracle DAO",
    },
    pdao: { title: "Protocollo DAO", overview: "Panoramica", pdao: "Il Protocollo DAO", participating: "Partecipazione alle Proposte" },
    upgrades: {
      title: "Aggiornamenti del Protocollo",
      saturn1: "L'Aggiornamento Saturn 1",
      saturn0: "L'Aggiornamento Saturn 0",
      houston: "L'Aggiornamento Houston",
      houstonOverview: "Panoramica",
      houstonGettingStarted: "Iniziare con Houston",
      houstonPdao: "Il Protocollo DAO",
      atlas: "L'Aggiornamento Atlas",
      lebs: "Minipools a Basso ETH Bond",
      redstone: "Redstone e The Merge",
      redstoneWhatsNew: "L'Aggiornamento Rocket Pool Redstone",
      redstoneDocker: "[Modalità Docker] Guida all'Aggiornamento Redstone e The Merge",
    ...
    legacy: {
      title: "Guide Legacy",
      v13Update: "Aggiornamento a Smart Node v1.3.x",
      migrating: "Migrazione dello Smart Node dai Test Beta Precedenti",
      atlas: "L'Aggiornamento Atlas",
      lebs: "Minipool con Garanzia ETH Inferiore",
      redstone: "Redstone e The Merge",
      redstoneWhatsNew: "L'Aggiornamento Redstone di Rocket Pool",
      redstoneDocker: "[Modalità Docker] Guida all'Aggiornamento Redstone e The Merge",
      redstoneHybrid: "[Modalità Ibrida] Guida all'Aggiornamento Redstone e The Merge",
      redstoneNative: "[Modalità Nativa] Guida all'Aggiornamento Redstone e The Merge",
      houston: "L'Aggiornamento Houston",
      ...
      houstonGettingStarted: "Iniziare con Houston",
      houstonPdao: "Il Protocollo DAO",
      houstonParticipate: "Partecipazione alle Proposte",
      houstonStakeOnBehalf: "Stake di ETH per Conto del Nodo",
      houstonRplWithdrawal: "Indirizzo di Prelievo RPL",
      preparePi: "Preparazione di un Raspberry Pi",
    },
  },
  tr: {
    ...
    liquidStaking: {
      title: "Likit Staking (rETH)",
      overview: "Genel Bakış",
      viaRp: "Rocket Pool üzerinden doğrudan staking",
      viaL1: "Layer 1'de DEX üzerinden staking",
      viaL2: "Layer 2'de DEX üzerinden staking",
      onBehalf: "Bir düğüm adına staking",
    },
    nodeStaking: {
      title: "Düğüm Operatörü Kılavuzu",
      responsibilities: "Düğüm Operatörünün Sorumlulukları",
      platform: "Düğüm Gereksinimleri ve Platform Seçimi",
      localNode: "Yerel Düğüm Hazırlama",
      localOverview: "Genel Bakış",
      hardware: "Staking Donanımı Seçimi",
      preparePC: "PC, Mini-PC veya NUC Hazırlama",
      prepareMac: "Mac Hazırlama",
      ssh: "Secure Shell (SSH) Girişi",
      serverNode: "Sunucu Düğümü Hazırlama",
      serverOverview: "Genel Bakış",
      providers: "Barındırma Sağlayıcısı Seçimi",
      serverOS: "İşletim Sistemini Hazırlama",
      securing: "Düğümünüzü Güvence Altına Alma",
      tailscale: "Tailscale",
      installing: "Rocket Pool Kurulumu",
      installOverview: "Genel Bakış",
      ethClients: "ETH İstemcilerinizi Seçme",
      installModes: "Rocket Pool Modu Seçimi",
      docker: "Docker ile Standart Rocket Pool Düğümü Oluşturma",
      native: "Docker Olmadan Native Rocket Pool Düğümü Oluşturma",
      configuring: "Rocket Pool Yapılandırması",
      configOverview: "Genel Bakış",
      configDocker: "Smart Node Stack Yapılandırması (Docker/hibrit mod)",
      configNative: "Smart Node Stack Yapılandırması (native)",
      advancedConfig: "Docker Modu için Gelişmiş Smart Node Yapılandırması",
      provisioning: "Düğümünüzü Hazırlama",
      provisioningOverview: "Genel Bakış",
      startingRp: "Rocket Pool'u Başlatma",
      walletInit: "Yeni Cüzdan Oluşturma",
      recovering: "Mevcut Cüzdanı İçe Aktarma/Kurtarma",
      prepareNode: "Düğümünüzü Operasyona Hazırlama",
      ...
      maintenance: "İzleme ve Bakım",
      maintenanceOverview: "Genel Bakış",
      performance: "Düğüm Performansını İzleme",
      grafana: "Grafana Panelini Kurma",
      alerting: "Smart Node Stack Uyarı Bildirimleri",
      ...
      changeClients: "Execution veya Consensus Client Değiştirme",
      nodeMigration: "Bir Düğümden Diğerine Taşıma",
      rewards: "Ödül Talep Etme",
      rewardsOverview: "Genel Bakış",
      claimingRewards: "Düğüm Operatörü Ödüllerini Talep Etme",
      skimming: "Alınan Ödülleri Dağıtma",
      exiting: "Minipool'larınızdan Çıkış",
      shutdown: "Minipool Kapatma",
      faq: "SSS (Devam Ediyor)",
    },
    odao: {
      title: "Oracle DAO",
      overview: "Rocket Pool Oracle DAO",
      setup: "Oracle DAO Düğümü Kurulumu",
      testing: "Oracle DAO Düğümünüzü Test Etme",
      monitoring: "Oracle DAO Düğümünüzü İzleme",
      proposals: "Oracle DAO Önerileri",
    },
    pdao: { title: "Protokol DAO", overview: "Genel Bakış", pdao: "Protokol DAO", participating: "Önerilere Katılım" },
    upgrades: {
      title: "Protokol Güncellemeleri",
      saturn1: "Saturn 1 Güncellemesi",
      saturn0: "Saturn 0 Güncellemesi",
      houston: "Houston Güncellemesi",
      houstonOverview: "Genel Bakış",
      houstonGettingStarted: "Houston'a Başlarken",
      houstonPdao: "Protokol DAO",
      atlas: "Atlas Güncellemesi",
      lebs: "Düşük ETH Bond Minipools",
      redstone: "Redstone ve Birleşme",
      redstoneWhatsNew: "Rocket Pool Redstone Güncellemesi",
      redstoneDocker: "[Docker Modu] Redstone Güncellemesi ve Birleşme Kılavuzu",
      redstoneHybrid: "[Hibrit Mod] Redstone Güncellemesi ve Birleşme Kılavuzu",
      redstoneNative: "[Yerel Mod] Redstone Güncellemesi ve Birleşme Kılavuzu",
    },
    testnet: { title: "Testnet", overview: "Test Ağında Pratik Yapma", mainnet: "Test Ağından Mainnet'e Geçiş" },
    legacy: {
      title: "Eski Kılavuzlar",
      v13Update: "Smart Node v1.3.x'e Yükseltme",
      migrating: "Önceki Beta Testlerinden Smart Node Taşıma",
      atlas: "Atlas Güncellemesi",
      lebs: "Düşük ETH Teminatlı Minipool'lar",
      redstone: "Redstone ve The Merge",
      redstoneWhatsNew: "Rocket Pool Redstone Güncellemesi",
      redstoneDocker: "[Docker Modu] Redstone Güncellemesi ve The Merge Kılavuzu",
      redstoneHybrid: "[Hibrit Modu] Redstone Güncellemesi ve The Merge Kılavuzu",
      redstoneNative: "[Native Modu] Redstone Güncellemesi ve The Merge Kılavuzu",
      houston: "Houston Güncellemesi",
      houstonOverview: "Genel Bakış",
      houstonGettingStarted: "Houston ile Başlarken",
      houstonPdao: "Protokol DAO",
      houstonParticipate: "Önerilere Katılım",
      houstonStakeOnBehalf: "Düğüm Adına ETH Stake Etme",
      houstonRplWithdrawal: "RPL Çekim Adresi",
      preparePi: "Raspberry Pi Hazırlama",
    },
  },
};
  ...
  return [
    {
      ...
      items: [
        ...
        },
        {
          ...
          collapsed: true,
          items: [{ text: t.shutdown, link: `${prefix}/node-staking/withdraw` }],
        },
    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          collapsed: true,
          items: [{ text: sidebarTranslations[lang].upgrades.lebs, link: `${prefix}/upgrades/atlas/lebs` }],
        },
        {
