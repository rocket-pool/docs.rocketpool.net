...
const sidebarTranslations: Record<string, SidebarTranslation> = {
  ...
  pt: {
    ...
    nodeStaking: {
      ...
      advancedConfig: "Configuração Avançada do Smartnode para Modo Docker",
    ...
    legacy: {
      title: "Guias Antigos",
      v13Update: "Atualizando para Smartnode v1.3.x",
      migrating: "Migrando o Smartnode de Testes Beta Anteriores",
      atlas: "A Atualização Atlas",
  ...
  ru: {
    ...
    nodeStaking: {
      ...
      configDocker: "Настройка стека Smartnode (режим Docker/гибридный)",
      configNative: "Настройка стека Smartnode (нативный)",
      advancedConfig: "Расширенная настройка Smartnode для режима Docker",
    ...
    legacy: {
      ...
      v13Update: "Обновление до Smartnode v1.3.x",
      migrating: "Миграция Smartnode с предыдущих бета-тестов",
      atlas: "Обновление Atlas",
  ...
  it: {
    ...
    nodeStaking: {
      ...
      configDocker: "Configurazione dello Stack Smartnode (modalità Docker/ibrida)",
      configNative: "Configurazione dello Stack Smartnode (nativo)",
      advancedConfig: "Configurazione Avanzata Smartnode per Modalità Docker",
    ...
    legacy: {
      title: "Guide Legacy",
      v13Update: "Aggiornamento a Smartnode v1.3.x",
      migrating: "Migrazione dello Smartnode dai Test Beta Precedenti",
      atlas: "L'Aggiornamento Atlas",
  ...
  tr: {
    ...
    nodeStaking: {
      ...
      configDocker: "Smartnode Stack Yapılandırması (Docker/hibrit mod)",
      configNative: "Smartnode Stack Yapılandırması (native)",
      advancedConfig: "Docker Modu için Gelişmiş Smartnode Yapılandırması",
    ...
    legacy: {
      ...
      v13Update: "Smartnode v1.3.x'e Yükseltme",
      migrating: "Önceki Beta Testlerinden Smartnode Taşıma",
      atlas: "Atlas Güncellemesi",
