...
type SidebarTranslation = {
  overview: { title: string; overview: string; explainerSeries: string; faq: string; contracts: string; glossary: string };
  ...
  nodeStaking: {
    ...
    mev: string;
    minipools: string;
    minipoolsOverview: string;
    createValidator: string;
    delegates: string;
    soloMigration: string;
    lebMigration: string;
    credit: string;
    maintenance: string;
    ...
    snapshot: string;
    delegating: string;
    viewingProposal: string;
    voting: string;
    creatingProposal: string;
    executing: string;
    claimingBonds: string;
    treasurySpend: string;
    exiting: string;
    shutdown: string;
    rescueDissolved: string;
    faq: string;
  };
  odao: { title: string; overview: string; setup: string; testing: string; monitoring: string; proposals: string };
  upgrades: { title: string; saturn0: string };
...
const sidebarTranslations: Record<string, SidebarTranslation> = {
  en: {
    overview: { title: "Overview", overview: "Overview", explainerSeries: "Explainer Series", faq: "Frequently Asked Questions", contracts: "Contracts & Integrations", glossary: "Glossary" },
    ...
    upgrades: { title: "Protocol Upgrades", saturn0: "The Saturn 0 Upgrade" },
  ...
  zh: {
    overview: { title: "概述", overview: "概述", explainerSeries: "解释系列", faq: "常见问题", contracts: "合约与集成", glossary: "术语表" },
    ...
    upgrades: { title: "协议升级", saturn0: "Saturn 0 升级" },
  ...
  es: {
    overview: { title: "Descripción general", overview: "Descripción general", explainerSeries: "Serie Explicativa", faq: "Preguntas Frecuentes", contracts: "Contratos e Integraciones", glossary: "Glosario" },
    ...
    upgrades: { title: "Actualizaciones del Protocolo", saturn0: "La Actualización Saturn 0" },
  ...
  fr: {
    overview: { title: "Aperçu", overview: "Aperçu", explainerSeries: "Série Explicative", faq: "Questions Fréquentes", contracts: "Contrats et Intégrations", glossary: "Glossaire" },
    ...
    upgrades: { title: "Mises à Jour du Protocole", saturn0: "La Mise à Jour Saturn 0" },
  ...
  de: {
    overview: { title: "Übersicht", overview: "Übersicht", explainerSeries: "Erklärungsreihe", faq: "Häufig gestellte Fragen", contracts: "Verträge & Integrationen", glossary: "Glossar" },
    ...
    upgrades: { title: "Protokoll-Upgrades", saturn0: "Das Saturn 0 Upgrade" },
  ...
  ja: {
    overview: { title: "概要", overview: "概要", explainerSeries: "解説シリーズ", faq: "よくある質問", contracts: "コントラクトと統合", glossary: "用語集" },
    ...
    upgrades: { title: "プロトコルアップグレード", saturn0: "Saturn 0アップグレード" },
  ...
  ko: {
    overview: { title: "개요", overview: "개요", explainerSeries: "설명 시리즈", faq: "자주 묻는 질문", contracts: "컨트랙트 및 통합", glossary: "용어집" },
    ...
    nodeStaking: { title: "노드 운영자 가이드", responsibilities: "노드 운영자의 책임", platform: "노드 요구 사항 및 플랫폼 선택", localNode: "로컬 노드 준비", localOverview: "개요", hardware: "스테이킹 하드웨어 선택", preparePC: "PC, 미니 PC 또는 NUC 준비", prepareMac: "Mac 준비", ssh: "Secure Shell (SSH) 소개", serverNode: "서버 노드 준비", serverOverview: "개요", providers: "호스팅 제공업체 선택", serverOS: "운영 체제 준비", securing: "노드 보안", tailscale: "Tailscale", installing: "Rocket Pool 설치", installOverview: "개요", ethClients: "ETH 클라이언트 선택", installModes: "Rocket Pool 모드 선택", docker: "Docker로 표준 Rocket Pool 노드 생성", native: "Docker 없이 네이티브 Rocket Pool 노드 생성", configuring: "Rocket Pool 구성", configOverview: "개요", configDocker: "Smartnode 스택 구성 (Docker/하이브리드 모드)", configNative: "Smartnode 스택 구성 (네이티브)", advancedConfig: "Docker 모드용 고급 Smartnode 구성", provisioning: "노드 프로비저닝", provisioningOverview: "개요", startingRp: "Rocket Pool 시작", walletInit: "새 지갑 생성", recovering: "기존 지갑 가져오기/복구", prepareNode: "운영을 위한 노드 준비", cliIntro: "명령줄 인터페이스 소개", fallback: "폴백 노드 지정", feeDistrib: "수수료 분배기와 스무딩 풀", mev: "MEV, MEV-Boost 및 MEV 보상", minipools: "Minipool 생성 또는 마이그레이션", minipoolsOverview: "개요", createValidator: "새 Minipool (검증자) 생성", delegates: "Minipool 델리게이트", soloMigration: "솔로 검증자를 Minipool로 전환", lebMigration: "16-ETH Minipool을 8-ETH로 마이그레이션", credit: "예치금 크레딧 시스템", maintenance: "모니터링 및 유지 관리", maintenanceOverview: "개요", performance: "노드 성능 모니터링", grafana: "Grafana 대시보드 설정", alerting: "Smartnode 스택 알림", updates: "업데이트 확인", backups: "노드 백업", masquerade: "다른 노드 주소로 위장", historyExpiry: "머지 이전 기록 만료", pruning: "실행 클라이언트 프루닝", changeClients: "실행 또는 합의 클라이언트 변경", nodeMigration: "노드 간 이동", rewards: "보상 청구", rewardsOverview: "개요", claimingRewards: "노드 운영자 보상 청구", skimming: "스키밍 보상 분배", governance: "pDAO 거버넌스 참여", governanceOverview: "개요", pdao: "프로토콜 DAO", participating: "온체인 pDAO 제안 참여", snapshot: "Snapshot 시그널링 주소 설정", delegating: "투표권 위임", viewingProposal: "제안 상태 보기", voting: "제안에 투표", creatingProposal: "제안 생성", executing: "성공적인 제안 실행", claimingBonds: "본드 및 보상 청구", treasurySpend: "정기 국고 지출 생성 및 청구", exiting: "Minipool 종료", shutdown: "Minipool 종료", rescueDissolved: "해산된 Minipool 구출", faq: "FAQ (진행 중)" },
    ...
    upgrades: { title: "프로토콜 업그레이드", saturn0: "Saturn 0 업그레이드" },
  ...
  pt: {
    overview: { title: "Visão Geral", overview: "Visão Geral", explainerSeries: "Série Explicativa", faq: "Perguntas Frequentes", contracts: "Contratos e Integrações", glossary: "Glossário" },
    ...
    upgrades: { title: "Atualizações do Protocolo", saturn0: "A Atualização Saturn 0" },
  ...
  ru: {
    overview: { title: "Обзор", overview: "Обзор", explainerSeries: "Серия объяснений", faq: "Часто задаваемые вопросы", contracts: "Контракты и интеграции", glossary: "Глоссарий" },
    ...
    nodeStaking: { title: "Руководство оператора ноды", responsibilities: "Обязанности оператора ноды", platform: "Требования к ноде и выбор платформы", localNode: "Подготовка локальной ноды", localOverview: "Обзор", hardware: "Выбор оборудования для стейкинга", preparePC: "Подготовка ПК, мини-ПК или NUC", prepareMac: "Подготовка Mac", ssh: "Введение в Secure Shell (SSH)", serverNode: "Подготовка серверной ноды", serverOverview: "Обзор", providers: "Выбор хостинг-провайдера", serverOS: "Подготовка операционной системы", securing: "Защита вашей ноды", tailscale: "Tailscale", installing: "Установка Rocket Pool", installOverview: "Обзор", ethClients: "Выбор ETH-клиентов", installModes: "Выбор режима Rocket Pool", docker: "Создание стандартной ноды Rocket Pool с Docker", native: "Создание нативной ноды Rocket Pool без Docker", configuring: "Настройка Rocket Pool", configOverview: "Обзор", configDocker: "Настройка стека Smartnode (режим Docker/гибридный)", configNative: "Настройка стека Smartnode (нативный)", advancedConfig: "Расширенная настройка Smartnode для режима Docker", provisioning: "Подготовка вашей ноды", provisioningOverview: "Обзор", startingRp: "Запуск Rocket Pool", walletInit: "Создание нового кошелька", recovering: "Импорт/восстановление существующего кошелька", prepareNode: "Подготовка ноды к работе", cliIntro: "Введение в командную строку", fallback: "Указание резервной ноды", feeDistrib: "Распределители комиссий и Smoothing Pool", mev: "MEV, MEV-Boost и вознаграждения MEV", minipools: "Создание или миграция Minipool", minipoolsOverview: "Обзор", createValidator: "Создание нового Minipool (валидатора)", delegates: "Делегат Minipool", soloMigration: "Конвертация соло-валидатора в Minipool", lebMigration: "Миграция 16-ETH Minipool в 8-ETH", credit: "Система депозитных кредитов", maintenance: "Мониторинг и обслуживание", maintenanceOverview: "Обзор", performance: "Мониторинг производительности ноды", grafana: "Настройка панели Grafana", alerting: "Уведомления стека Smartnode", updates: "Проверка обновлений", backups: "Резервное копирование ноды", masquerade: "Маскировка под другой адрес ноды", historyExpiry: "Истечение истории до слияния", pruning: "Обрезка клиента исполнения", changeClients: "Смена клиентов исполнения или консенсуса", nodeMigration: "Переход с одной ноды на другую", rewards: "Получение вознаграждений", rewardsOverview: "Обзор", claimingRewards: "Получение вознаграждений оператора ноды", skimming: "Распределение снятых вознаграждений", governance: "Участие в управлении pDAO", governanceOverview: "Обзор", pdao: "Протокол DAO", participating: "Участие в предложениях pDAO на блокчейне", snapshot: "Настройка адреса сигнализации Snapshot", delegating: "Делегирование права голоса", viewingProposal: "Просмотр состояния предложения", voting: "Голосование по предложению", creatingProposal: "Создание предложения", executing: "Исполнение успешного предложения", claimingBonds: "Получение залогов и вознаграждений", treasurySpend: "Создание и получение регулярных расходов казначейства", exiting: "Выход из Minipool", shutdown: "Закрытие Minipool", rescueDissolved: "Спасение распущенного Minipool", faq: "FAQ (В процессе)" },
    ...
    upgrades: { title: "Обновления протокола", saturn0: "Обновление Saturn 0" },
  ...
  it: {
    overview: { title: "Panoramica", overview: "Panoramica", explainerSeries: "Serie Esplicativa", faq: "Domande Frequenti", contracts: "Contratti e Integrazioni", glossary: "Glossario" },
    ...
    nodeStaking: { title: "Guida dell'Operatore di Nodo", responsibilities: "Responsabilità dell'Operatore di Nodo", platform: "Requisiti del Nodo e Scelta della Piattaforma", localNode: "Preparare un Nodo Locale", localOverview: "Panoramica", hardware: "Selezione dell'Hardware per lo Staking", preparePC: "Preparare un PC, Mini-PC o NUC", prepareMac: "Preparare un Mac", ssh: "Introduzione a Secure Shell (SSH)", serverNode: "Preparare un Nodo Server", serverOverview: "Panoramica", providers: "Selezione di un Provider di Hosting", serverOS: "Preparazione del Sistema Operativo", securing: "Proteggere il Tuo Nodo", tailscale: "Tailscale", installing: "Installazione di Rocket Pool", installOverview: "Panoramica", ethClients: "Scelta dei Client ETH", installModes: "Selezione di una Modalità Rocket Pool", docker: "Creazione di un Nodo Rocket Pool Standard con Docker", native: "Creazione di un Nodo Rocket Pool Nativo senza Docker", configuring: "Configurazione di Rocket Pool", configOverview: "Panoramica", configDocker: "Configurazione dello Stack Smartnode (modalità Docker/ibrida)", configNative: "Configurazione dello Stack Smartnode (nativo)", advancedConfig: "Configurazione Avanzata Smartnode per Modalità Docker", provisioning: "Provisioning del Tuo Nodo", provisioningOverview: "Panoramica", startingRp: "Avvio di Rocket Pool", walletInit: "Creazione di un Nuovo Portafoglio", recovering: "Importazione/Recupero di un Portafoglio Esistente", prepareNode: "Preparazione del Nodo per l'Operazione", cliIntro: "Introduzione all'Interfaccia a Riga di Comando", fallback: "Specifica di un Nodo di Fallback", feeDistrib: "Distributori di Commissioni e lo Smoothing Pool", mev: "MEV, MEV-Boost e Ricompense MEV", minipools: "Creazione o Migrazione di Minipool", minipoolsOverview: "Panoramica", createValidator: "Creazione di un nuovo Minipool (Validatore)", delegates: "Il Delegato del Minipool", soloMigration: "Conversione di un Validatore Solo in Minipool", lebMigration: "Migrazione di un Minipool da 16-ETH a 8-ETH", credit: "Il Sistema di Credito per Depositi", maintenance: "Monitoraggio e Manutenzione", maintenanceOverview: "Panoramica", performance: "Monitoraggio delle Prestazioni del Nodo", grafana: "Configurazione della Dashboard Grafana", alerting: "Notifiche di Avviso dello Stack Smartnode", updates: "Verifica degli Aggiornamenti", backups: "Backup del Tuo Nodo", masquerade: "Mascheramento come Altro Indirizzo di Nodo", historyExpiry: "Scadenza della Cronologia Pre-Merge", pruning: "Potatura del Client di Esecuzione", changeClients: "Cambio dei Client di Esecuzione o Consenso", nodeMigration: "Passaggio da un Nodo all'Altro", rewards: "Richiesta delle Ricompense", rewardsOverview: "Panoramica", claimingRewards: "Richiesta delle Ricompense dell'Operatore di Nodo", skimming: "Distribuzione delle Ricompense Scremate", governance: "Partecipazione alla Governance pDAO", governanceOverview: "Panoramica", pdao: "Il Protocollo DAO", participating: "Partecipazione alle Proposte pDAO on-chain", snapshot: "Impostazione dell'Indirizzo di Segnalazione Snapshot", delegating: "Delega del Potere di Voto", viewingProposal: "Visualizzazione dello Stato di una Proposta", voting: "Votazione su una Proposta", creatingProposal: "Creazione di una Proposta", executing: "Esecuzione di una proposta riuscita", claimingBonds: "Richiesta di Garanzie e Ricompense", treasurySpend: "Creazione e Richiesta di una spesa ricorrente del tesoro", exiting: "Uscita dai Tuoi Minipool", shutdown: "Chiusura di un Minipool", rescueDissolved: "Salvataggio di un Minipool Dissolto", faq: "FAQ (In corso)" },
    ...
    upgrades: { title: "Aggiornamenti del Protocollo", saturn0: "L'Aggiornamento Saturn 0" },
  ...
  tr: {
    overview: { title: "Genel Bakış", overview: "Genel Bakış", explainerSeries: "Açıklama Serisi", faq: "Sık Sorulan Sorular", contracts: "Sözleşmeler ve Entegrasyonlar", glossary: "Sözlük" },
    ...
    nodeStaking: { title: "Düğüm Operatörü Kılavuzu", responsibilities: "Düğüm Operatörünün Sorumlulukları", platform: "Düğüm Gereksinimleri ve Platform Seçimi", localNode: "Yerel Düğüm Hazırlama", localOverview: "Genel Bakış", hardware: "Staking Donanımı Seçimi", preparePC: "PC, Mini-PC veya NUC Hazırlama", prepareMac: "Mac Hazırlama", ssh: "Secure Shell (SSH) Girişi", serverNode: "Sunucu Düğümü Hazırlama", serverOverview: "Genel Bakış", providers: "Barındırma Sağlayıcısı Seçimi", serverOS: "İşletim Sistemini Hazırlama", securing: "Düğümünüzü Güvence Altına Alma", tailscale: "Tailscale", installing: "Rocket Pool Kurulumu", installOverview: "Genel Bakış", ethClients: "ETH İstemcilerinizi Seçme", installModes: "Rocket Pool Modu Seçimi", docker: "Docker ile Standart Rocket Pool Düğümü Oluşturma", native: "Docker Olmadan Native Rocket Pool Düğümü Oluşturma", configuring: "Rocket Pool Yapılandırması", configOverview: "Genel Bakış", configDocker: "Smartnode Stack Yapılandırması (Docker/hibrit mod)", configNative: "Smartnode Stack Yapılandırması (native)", advancedConfig: "Docker Modu için Gelişmiş Smartnode Yapılandırması", provisioning: "Düğümünüzü Hazırlama", provisioningOverview: "Genel Bakış", startingRp: "Rocket Pool'u Başlatma", walletInit: "Yeni Cüzdan Oluşturma", recovering: "Mevcut Cüzdanı İçe Aktarma/Kurtarma", prepareNode: "Düğümünüzü Operasyona Hazırlama", cliIntro: "Komut Satırı Arayüzüne Giriş", fallback: "Yedek Düğüm Belirleme", feeDistrib: "Ücret Dağıtıcıları ve Smoothing Pool", mev: "MEV, MEV-Boost ve MEV Ödülleri", minipools: "Minipool Oluşturma veya Taşıma", minipoolsOverview: "Genel Bakış", createValidator: "Yeni Minipool (Doğrulayıcı) Oluşturma", delegates: "Minipool Delegesi", soloMigration: "Solo Doğrulayıcıyı Minipool'a Dönüştürme", lebMigration: "16-ETH Minipool'u 8-ETH'ye Taşıma", credit: "Depozito Kredi Sistemi", maintenance: "İzleme ve Bakım", maintenanceOverview: "Genel Bakış", performance: "Düğüm Performansını İzleme", grafana: "Grafana Panelini Kurma", alerting: "Smartnode Stack Uyarı Bildirimleri", updates: "Güncellemeleri Kontrol Etme", backups: "Düğümünüzü Yedekleme", masquerade: "Başka Düğüm Adresi Olarak Maskeleme", historyExpiry: "Merge Öncesi Geçmişi Sona Erdirme", pruning: "Execution Client Budama", changeClients: "Execution veya Consensus Client Değiştirme", nodeMigration: "Bir Düğümden Diğerine Taşıma", rewards: "Ödül Talep Etme", rewardsOverview: "Genel Bakış", claimingRewards: "Düğüm Operatörü Ödüllerini Talep Etme", skimming: "Alınan Ödülleri Dağıtma", governance: "pDAO Yönetimine Katılım", governanceOverview: "Genel Bakış", pdao: "Protokol DAO", participating: "Zincir Üstü pDAO Önerilerine Katılım", snapshot: "Snapshot Sinyal Adresinizi Ayarlama", delegating: "Oy Gücü Devretme", viewingProposal: "Öneri Durumunu Görüntüleme", voting: "Öneriye Oy Verme", creatingProposal: "Öneri Oluşturma", executing: "Başarılı bir öneriyi yürütme", claimingBonds: "Teminat ve Ödülleri Talep Etme", treasurySpend: "Yinelenen hazine harcaması oluşturma ve talep etme", exiting: "Minipool'larınızdan Çıkış", shutdown: "Minipool Kapatma", rescueDissolved: "Çözülmüş Minipool'u Kurtarma", faq: "SSS (Devam Ediyor)" },
    ...
    upgrades: { title: "Protokol Güncellemeleri", saturn0: "Saturn 0 Güncellemesi" },
...
function overview(prefix: string, lang: string) {
  const t = sidebarTranslations[lang].overview;
  return [
    {
      text: t.title,
      collapsed: false,
      items: [
        { text: t.overview, link: `${prefix}/overview/` },
        { text: t.explainerSeries, link: `${prefix}/overview/explainer-series` },
        { text: t.faq, link: `${prefix}/overview/faq` },
        { text: t.contracts, link: `${prefix}/overview/contracts-integrations` },
        { text: t.glossary, link: `${prefix}/overview/glossary` },
      ],
    },
  ];
}
  ...
  return [
    {
      ...
      items: [
        ...
        },
        {
          ...
          collapsed: true,
          items: [
            { text: t.minipoolsOverview, link: `${prefix}/node-staking/minipools/overview` },
            { text: t.createValidator, link: `${prefix}/node-staking/create-validator` },
            { text: t.delegates, link: `${prefix}/node-staking/minipools/delegates` },
            { text: t.soloMigration, link: `${prefix}/node-staking/solo-staker-migration` },
            { text: t.lebMigration, link: `${prefix}/node-staking/leb-migration` },
            { text: t.credit, link: `${prefix}/node-staking/credit` },
          ],
        },
        {
          text: t.maintenance,
        ...
        },
        {
          ...
          collapsed: true,
          items: [
            { text: t.governanceOverview, link: `${prefix}/node-staking/governance/overview` },
            { text: t.pdao, link: `${prefix}/legacy/houston/pdao#the-protocol-dao-pdao` },
            { text: t.participating, link: `${prefix}/legacy/houston/participate#participating-in-on-chain-pdao-proposals` },
            { text: t.snapshot, link: `${prefix}/legacy/houston/participate#setting-your-snapshot-signalling-address` },
            { text: t.delegating, link: `${prefix}/legacy/houston/participate#delegating-voting-power` },
            { text: t.viewingProposal, link: `${prefix}/legacy/houston/participate#viewing-the-state-of-a-proposal` },
            { text: t.voting, link: `${prefix}/legacy/houston/participate#voting-on-a-proposal` },
            { text: t.creatingProposal, link: `${prefix}/legacy/houston/participate#creating-a-proposal` },
            { text: t.executing, link: `${prefix}/legacy/houston/participate#executing-a-successful-proposal` },
            { text: t.claimingBonds, link: `${prefix}/legacy/houston/participate#claiming-bonds-and-rewards` },
            { text: t.treasurySpend, link: `${prefix}/legacy/houston/participate#creating-a-recurring-treasury-spend` },
          ],
        },
        {
          text: t.exiting,
          ...
          items: [
            ...
            { text: t.rescueDissolved, link: `${prefix}/node-staking/rescue-dissolved` },
          ],
        },
...
function odao(prefix: string, lang: string) {
  const t = sidebarTranslations[lang].odao;
  return [
    {
      text: t.title,
      collapsed: false,
      items: [
        { text: t.overview, link: `${prefix}/odao/overview` },
        { text: t.setup, link: `${prefix}/odao/setup` },
        { text: t.testing, link: `${prefix}/odao/testing` },
        { text: t.monitoring, link: `${prefix}/odao/monitoring` },
        { text: t.proposals, link: `${prefix}/odao/proposals` },
      ],
    },
  ];
}

function upgrades(prefix: string, lang: string) {
  const t = sidebarTranslations[lang].upgrades;
  return [
    {
      text: t.title,
      collapsed: false,
      items: [{ text: t.saturn0, link: `${prefix}/upgrades/saturn-0/whats-new` }],
    },
  ];
}

function testnet(prefix: string, lang: string) {
  const t = sidebarTranslations[lang].testnet;
  return [
    {
      text: t.title,
      collapsed: false,
      items: [
        { text: t.overview, link: `${prefix}/testnet/overview` },
        { text: t.mainnet, link: `${prefix}/testnet/mainnet` },
      ],
    },
  ];
}

function legacy(prefix: string, lang: string) {
  const t = sidebarTranslations[lang].legacy;
  return [
    {
      text: t.title,
      collapsed: false,
      items: [
        { text: t.v13Update, link: `${prefix}/legacy/v1.3-update` },
        { text: t.migrating, link: `${prefix}/legacy/upgrading` },
        { text: t.atlas, link: `${prefix}/legacy/atlas/whats-new` },
        { text: t.lebs, link: `${prefix}/legacy/atlas/lebs` },
        {
          text: t.redstone,
          link: `${prefix}/legacy/redstone/whats-new`,
          collapsed: true,
          items: [
            { text: t.redstoneWhatsNew, link: `${prefix}/legacy/redstone/whats-new` },
            { text: t.redstoneDocker, link: `${prefix}/legacy/redstone/docker-migration` },
            { text: t.redstoneHybrid, link: `${prefix}/legacy/redstone/hybrid-migration` },
            { text: t.redstoneNative, link: `${prefix}/legacy/redstone/native-migration` },
          ],
        },
        {
          text: t.houston,
          ...
          items: [
            { text: t.houstonOverview, link: `${prefix}/legacy/houston/whats-new` },
            { text: t.houstonGettingStarted, link: `${prefix}/legacy/houston/getting-started` },
            { text: t.houstonPdao, link: `${prefix}/legacy/houston/pdao` },
            { text: t.houstonParticipate, link: `${prefix}/legacy/houston/participate` },
            { text: t.houstonStakeOnBehalf, link: `${prefix}/legacy/houston/stake-eth-on-behalf` },
            { text: t.houstonRplWithdrawal, link: `${prefix}/legacy/houston/rpl-withdrawal-address` },
          ],
        },
        { text: t.preparePi, link: `${prefix}/node-staking/local/prepare-pi` },
      ],
    },
  ];
}
...
function localeSidebars() {
  ...
  for (const { lang } of locales) {
    const prefix = lang === "en" ? "" : `/${lang}`;
    sidebar[`${prefix}/overview`] = overview(prefix, lang);
    sidebar[`${prefix}/liquid-staking`] = liquidStaking(prefix, lang);
    sidebar[`${prefix}/node-staking`] = nodeStaking(prefix, lang);
    sidebar[`${prefix}/odao`] = odao(prefix, lang);
    sidebar[`${prefix}/upgrades`] = upgrades(prefix, lang);
    sidebar[`${prefix}/testnet`] = testnet(prefix, lang);
    sidebar[`${prefix}/legacy`] = legacy(prefix, lang);
  }
  return sidebar;
}
